  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$addChild = function(child, updateCall, pos) {
        ...
        if ((($a = child.shape == null) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
          shape = child.$shape();
          child['$plot='](self);
      ...
      def.$update = function() {
        ...
        return ($a = ($b = self.updateCalls).$each, $a._p = (TMP_1 = function(k, v){var self = TMP_1._s || this, $a, args = nil;
if (k == null) k = nil;if (v == null) v = nil;
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(dim, xlim, ylim, style) {
        ...
        if ((($a = self.xylim0['$[]']("x")['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
      ...
      def.$update = function(active) {
        ...
        if ((($a = self['$synced?']()) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
          list = ($a = ($b = self.list).$select, $a._p = (TMP_2 = function(e){var self = TMP_2._s || this, $a;
if (e == null) e = nil;
          return ((($a = active['$empty?']()) !== false && $a !== nil) ? $a : (active['$include?'](e['$[]'](1))))}, TMP_2._s = self, TMP_2), $a).call($b);
          self.xylim['$[]']("x")['$[]='](0, ($a = ($c = list).$map, $a._p = (TMP_3 = function(e){var self = TMP_3._s || this, e2 = nil;
if (e == null) e = nil;
          ...
          self.xylim['$[]']("x")['$[]='](1, ($a = ($d = list).$map, $a._p = (TMP_4 = function(e){var self = TMP_4._s || this, e2 = nil;
if (e == null) e = nil;
          e2 = ((function() {if (e['$[]'](0)['$==']("element")) {
              return e['$[]'](2).$xylim()
              } else {
          ...
          self.xylim['$[]']("y")['$[]='](0, ($a = ($e = list).$map, $a._p = (TMP_5 = function(e){var self = TMP_5._s || this, e2 = nil;
if (e == null) e = nil;
          e2 = ((function() {if (e['$[]'](0)['$==']("element")) {
              return e['$[]'](2).$xylim()
              } else {
          ...
          self.xylim['$[]']("y")['$[]='](1, ($a = ($f = list).$map, $a._p = (TMP_6 = function(e){var self = TMP_6._s || this, e2 = nil;
if (e == null) e = nil;
          e2 = ((function() {if (e['$[]'](0)['$==']("element")) {
              return e['$[]'](2).$xylim()
              } else {
        ...
        if ((($a = self.syncedChildren['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
          return nil
          } else {
          return ($a = ($g = self.syncedChildren).$each, $a._p = (TMP_7 = function(c){var self = TMP_7._s || this;
if (c == null) c = nil;
      ...
      def.$add = function(element, mode, id) {
        ...
        if ((($a = self['$synced?']()) !== nil && (!$a._isBoolean || $a == true))) {
          return nil};
        return (function() {$case = mode;if ("element"['$===']($case)) {if ((($a = element.$xylim()) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      def.$toggleZoomTo = function(plot, type) {
        ...
        if ((($a = self.zoom['$[]']("active")) !== nil && (!$a._isBoolean || $a == true))) {
          if ((($a = self.zoomShapes) !== nil && (!$a._isBoolean || $a == true))) {
            } else {
            self.zoomShapes = $hash2([], {});
            keys = [];
            if ((($a = type['$include?']("xpos")) !== nil && (!$a._isBoolean || $a == true))) {
              keys = keys['$+'](["xposmore", "xposless"])};
            if ((($a = type['$include?']("xneg")) !== nil && (!$a._isBoolean || $a == true))) {
              keys = keys['$+'](["xnegmore", "xnegless"])};
            if ((($a = type['$include?']("ypos")) !== nil && (!$a._isBoolean || $a == true))) {
              keys = keys['$+'](["yposmore", "yposless"])};
            if ((($a = type['$include?']("yneg")) !== nil && (!$a._isBoolean || $a == true))) {
              keys = keys['$+'](["ynegmore", "ynegless"])};
            if ((($a = type['$include?']("reset")) !== nil && (!$a._isBoolean || $a == true))) {
              keys = keys['$+'](["reset"])};
...
if (k == null) k = nil;
      ...
      return (def.$updateZoom = function(mode, times) {
        ...
        step = (0.1)['$/'](2);
        return ($a = ($b = ($range(0, times, true))).$each, $a._p = (TMP_13 = function(){var self = TMP_13._s || this, $a, $b, $case = nil;
        ...
        return (function() {$case = mode;if ("xposmore"['$===']($case)) {return ($a = "x1", $b = self.zoom, $b['$[]=']($a, $b['$[]']($a)['$+'](step['$*']((self.xylim['$[]']("x")['$[]'](1)['$-'](self.xylim['$[]']("x")['$[]'](0)))))))}else if ("xposless"['$===']($case)) {if (self.zoom['$[]']("x1")['$<']((step['$-']((1)['$/'](2)))['$*']((self.xylim['$[]']("x")['$[]'](1)['$-'](self.xylim['$[]']("x")['$[]'](0)))))) {
          ...
          }}else if ("reset"['$===']($case)) {return self.zoom['$[]=']("x0", self.zoom['$[]=']("x1", self.zoom['$[]=']("y0", self.zoom['$[]=']("y1", 0.0))))}else { return nil }})()}, TMP_13._s = self, TMP_13), $a).call($b);
      }, nil) && 'updateZoom';
    })(self, null);
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(id, type, bounds, style, length) {
        ...
        if ((($a = (($b = $opal.cvars['@@curveCpt']) == null ? nil : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
...
if (i == null) i = nil;
        return shape.graphics.lt(graph.$to_X(self.x['$[]'](i)),graph.$to_Y(self.y['$[]'](i)));}, TMP_17._s = self, TMP_17), $a).call($b);
        shape.graphics.lt(graph.$to_X(self.x['$[]'](-1)),graph.$to_Y(0.0));
        if ((($a = style['$[]']("close")) !== nil && (!$a._isBoolean || $a == true))) {
...
if (i == null) i = nil;
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(id, type, bounds, style, levels) {
        ...
        if ((($a = (($b = $opal.cvars['@@histCpt']) == null ? nil : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
      ...
      def.$init = function() {
        ...
        self.outside = [0]['$*'](2);}else if ("disc"['$===']($case)) {self.step = ($a = ($b = ($range(1, self.bounds.$length(), true))).$map, $a._p = (TMP_19 = function(i){var self = TMP_19._s || this;
          if (self.bounds == null) self.bounds = nil;
if (i == null) i = nil;
        return (self.bounds['$[]'](i)['$-'](self.bounds['$[]'](i['$-'](1)))).$abs()}, TMP_19._s = self, TMP_19), $a).call($b).$min();
        $a = [[0]['$*'](self.bounds.$length()), 0], self.cpt = $a[0], self.nbTot = $a[1];
        self.outside = [0]['$*'](2);
        if ((($a = self['$regular?']()) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
          self.ind = $hash2([], {});
          ($a = ($c = self.bounds).$each_with_index, $a._p = (TMP_20 = function(v, i){var self = TMP_20._s || this;
            if (self.ind == null) self.ind = nil;
if (v == null) v = nil;if (i == null) i = nil;
          return self.ind['$[]='](v, i)}, TMP_20._s = self, TMP_20), $a).call($c);
        };};
      ...
      def.$add = function(x) {
        ...
        $case = self.type;if ("cont"['$===']($case)) {($a = ($b = x).$each, $a._p = (TMP_21 = function(e){var self = TMP_21._s || this, $a, $b;
          if (self.bounds == null) self.bounds = nil;
          if (self.cpt == null) self.cpt = nil;
          if (self.outside == null) self.outside = nil;
if (e == null) e = nil;
        if ((($a = (($b = self.bounds['$[]'](0)['$<='](e)) ? e['$<='](self.bounds['$[]'](-1)) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          }}, TMP_21._s = self, TMP_21), $a).call($b)}else if ("disc"['$===']($case)) {($a = ($c = x).$each, $a._p = (TMP_22 = function(e){var self = TMP_22._s || this, $a, $b, i = nil;
          if (self.bounds == null) self.bounds = nil;
          if (self.cpt == null) self.cpt = nil;
          if (self.outside == null) self.outside = nil;
if (e == null) e = nil;
        i = self.$index(e);
          if ((($a = (($b = (0)['$<='](i)) ? i['$<'](self.bounds.$length()) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          };}, TMP_22._s = self, TMP_22), $a).call($c)};
        self.mean['$[]='](0, ($a = ($d = x).$inject, $a._p = (TMP_23 = function(e, e2){var self = TMP_23._s || this;
if (e == null) e = nil;if (e2 == null) e2 = nil;
        return e = e['$+'](e2)}, TMP_23._s = self, TMP_23), $a).call($d, self.nbTot.$to_f()['$*'](self.mean['$[]'](0))));
        self.mean['$[]='](1, ($a = ($e = x).$inject, $a._p = (TMP_24 = function(e, e2){var self = TMP_24._s || this;
if (e == null) e = nil;if (e2 == null) e2 = nil;
        return e = e['$+'](e2['$**'](2))}, TMP_24._s = self, TMP_24), $a).call($e, self.nbTot.$to_f()['$*'](self.mean['$[]'](1))));
      ...
      def.$level = function(val, mode) {
        ...
        if (self.type['$==']("disc")) {
          return nil};
        if ((($a = (($b = mode['$==']("inc")) ? val['$=='](0) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      def.$counts = function() {
        ...
        ($a = ($b = ($range(0, self.nbPart, true))).$each, $a._p = (TMP_25 = function(i){var self = TMP_25._s || this, $a, $b;
          if (self.levels == null) self.levels = nil;
          if (self.level == null) self.level = nil;
          if (self.cpt == null) self.cpt = nil;
if (i == null) i = nil;
        return ($a = i['$/']((2)['$**']((self.levels['$-'](self.level)))), $b = cptLevel, $b['$[]=']($a, $b['$[]']($a)['$+'](self.cpt['$[]'](i))))}, TMP_25._s = self, TMP_25), $a).call($b);
        return cptLevel;
      };
      ...
      def.$prob = function() {
        ...
        return ($a = ($b = self.$counts()).$map, $a._p = (TMP_26 = function(e){var self = TMP_26._s || this;
          if (self.nbTot == null) self.nbTot = nil;
if (e == null) e = nil;
        return e.$to_f()['$/'](self.nbTot.$to_f())}, TMP_26._s = self, TMP_26), $a).call($b);
      };
      ...
      def.$density = function(nbTot) {
        ...
        return ($a = ($b = cpt).$map, $a._p = (TMP_27 = function(e){var self = TMP_27._s || this;
if (e == null) e = nil;
        return e.$to_f()['$/'](nbTotal.$to_f())['$/'](step)}, TMP_27._s = self, TMP_27), $a).call($b);
      };
      ...
      def.$partBounds = function() {
        ...
        return (($a = ($b = ($range(0, ((2)['$**'](self.level)), true))).$map, $a._p = (TMP_28 = function(i){var self = TMP_28._s || this;
          if (self.bounds == null) self.bounds = nil;
if (i == null) i = nil;
        return self.bounds['$[]'](0)['$+'](i['$*'](step))}, TMP_28._s = self, TMP_28), $a).call($b))['$+']([self.bounds['$[]'](1)]);}else if ("disc"['$===']($case)) {s = self.step['$/'](2.0);
        return (($a = ($c = self.bounds).$map, $a._p = (TMP_29 = function(v){var self = TMP_29._s || this;
if (v == null) v = nil;
        return v['$-'](s)}, TMP_29._s = self, TMP_29), $a).call($c))['$+']([self.bounds['$[]'](-1)['$+'](s)]);}else { return nil }})();
      };
      ...
      def.$draw = function(nbTot) {
        ...
        ($a = ($b = ($range(0, (l), true))).$each, $a._p = (TMP_30 = function(i){var self = TMP_30._s || this;
...
if (i == null) i = nil;
      ...
      return (def.$updateHistAEP = function(x, mode) {
        ...
        self.aep['$[]=']("nbTot", ((function() {if ((($a = (["normal", "reduced"]['$include?'](mode))) !== nil && (!$a._isBoolean || $a == true))) {
          return self.nbTot
          } else {
          return 0
        }; return nil; })())['$+'](x.$length()));
        $a = [[], []], self.aep['$[]=']("xRect", $a[0]), self.aep['$[]=']("yRect", $a[1]);
        $case = self.type;if ("cont"['$===']($case)) {($a = ($b = x).$each_with_index, $a._p = (TMP_31 = function(e, i){var self = TMP_31._s || this, $a, $b, pos = nil;
          if (self.bounds == null) self.bounds = nil;
...
if (e == null) e = nil;if (i == null) i = nil;
        if ((($a = (($b = self.bounds['$[]'](0)['$<='](e)) ? e['$<='](self.bounds['$[]'](-1)) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          }}, TMP_31._s = self, TMP_31), $a).call($b)}else if ("disc"['$===']($case)) {($a = ($c = x).$each_with_index, $a._p = (TMP_32 = function(e, i){var self = TMP_32._s || this, $a, $b, pos = nil;
          if (self.bounds == null) self.bounds = nil;
          if (self.aep == null) self.aep = nil;
if (e == null) e = nil;if (i == null) i = nil;
        pos = self.$index(e);
          if ((($a = (($b = (0)['$<='](pos)) ? pos['$<'](self.bounds.$length()) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            return self.aep['$[]']("yRect")['$[]='](i, 0);
          };}, TMP_32._s = self, TMP_32), $a).call($c)};
        if (mode['$==']("new")) {
          self.aep['$[]=']("mean", [(($a = ($d = x).$inject, $a._p = (TMP_33 = function(e, e2){var self = TMP_33._s || this;
if (e == null) e = nil;if (e2 == null) e2 = nil;
          return e = e['$+'](e2)}, TMP_33._s = self, TMP_33), $a).call($d, 0))['$/'](self.aep['$[]']("nbTot")), (($a = ($e = x).$inject, $a._p = (TMP_34 = function(e, e2){var self = TMP_34._s || this;
if (e == null) e = nil;if (e2 == null) e2 = nil;
          return e = e['$+'](e2['$**'](2))}, TMP_34._s = self, TMP_34), $a).call($e, 0))['$/'](self.aep['$[]']("nbTot"))]);
    ...
    (function($base, $super) {
      ...
      def.$reset = function(curs) {
        ...
        if ((($a = self.transf) !== nil && (!$a._isBoolean || $a == true))) {
          curs['$<<'](1)};
        self.graphExp['$active=']((function() {if ((($a = self.transf) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        self.plotExp.$update();
        ($a = ($b = curs).$each, $a._p = (TMP_35 = function(cur){var self = TMP_35._s || this;
...
if (cur == null) cur = nil;
        self.hist['$[]'](cur).$reset();
          ...
          return self.hist['$[]'](cur).$draw();}, TMP_35._s = self, TMP_35), $a).call($b);
        self.plotHist.$update();
        self.$setCurHist((function() {if ((($a = self.transf) !== nil && (!$a._isBoolean || $a == true))) {
          return 1
          } else {
          return 0
        }; return nil; })());
      ...
      def.$setTCL = function() {
        ...
        if ((($a = self.checkTCL) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
      ...
      def.$updateTCL = function(state) {
        ...
        if ((($a = ($b = self.transf, $b !== false && $b !== nil ?(["mean", "sum", "stdMean"]['$include?'](self.transf['$[]']("name"))) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
          state = false
        };
      ...
      def.$setDistrib = function(name, params, cur) {
        ...
        if (params !== false && params !== nil) {
          ...
          params = [0, 1]
        }}else if ("saljus"['$===']($case)) {self.$setDistribAs($scope.Distribution.$new("exp", [1], $hash2(["name", "args"], {"name": "locationScale", "args": [90, 10]})));
        to_set = false;};
        if (to_set !== false && to_set !== nil) {
          self.exp['$[]'](cur).$setDistrib(name, params)};
        if ((($a = ($b = self.transf, $b !== false && $b !== nil ?cur['$=='](0) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      def.$setMLevel = function(val, mode) {
        ...
        if ((($a = (($b = mode['$==']("inc")) ? val['$=='](0) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          return self.mLevel};
        if ((($a = self.mLevels) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
      ...
      def.$setTransf = function(transf) {
        ...
        if ((($a = self.transf) !== nil && (!$a._isBoolean || $a == true))) {
          if (self.n['$=='](1)) {
            if ((($a = self.nold) !== nil && (!$a._isBoolean || $a == true))) {
              } else {
              self.nold = 10
            };
            self.n = self.nold;
            self.$setNbSim();};
          if ((($a = self.transfList) !== nil && (!$a._isBoolean || $a == true))) {
            } else {
            self.$initTransfList()
          };
      ...
      def.$sum_transf = function(v) {
        ...
        return ($a = ($b = v).$inject, $a._p = (TMP_36 = function(e, v2){var self = TMP_36._s || this;
if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2)}, TMP_36._s = self, TMP_36), $a).call($b, 0);
      };

      def.$sum_transf_by_index = function(inds, v) {
        var $a, $b, TMP_37, self = this;

        return ($a = ($b = inds).$inject, $a._p = (TMP_37 = function(e, i){var self = TMP_37._s || this;
if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](v['$[]'](i))}, TMP_37._s = self, TMP_37), $a).call($b, 0);
      };

      def.$mean_transf = function(v) {
        var $a, $b, TMP_38, self = this;

        return (($a = ($b = v).$inject, $a._p = (TMP_38 = function(e, v2){var self = TMP_38._s || this;
if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2)}, TMP_38._s = self, TMP_38), $a).call($b, 0))['$/'](self.n);
      };

      def.$mean_transf_by_index = function(inds, v) {
        var $a, $b, TMP_39, self = this;

        return (($a = ($b = inds).$inject, $a._p = (TMP_39 = function(e, i){var self = TMP_39._s || this;
if (e == null) e = nil;if (i == null) i = nil;
      ...
      def.$stdMean_transf = function(v, mu) {
        ...
        m = (($a = ($b = v).$inject, $a._p = (TMP_40 = function(e, v2){var self = TMP_40._s || this;
if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2)}, TMP_40._s = self, TMP_40), $a).call($b, 0))['$/'](self.n);
        m2 = (($a = ($c = v).$inject, $a._p = (TMP_41 = function(e, v2){var self = TMP_41._s || this;
if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2['$**'](2))}, TMP_41._s = self, TMP_41), $a).call($c, 0))['$/'](self.n);
      ...
      def.$stdMean_transf_by_index = function(inds, v, mu) {
        ...
        m = (($a = ($b = inds).$inject, $a._p = (TMP_42 = function(e, i){var self = TMP_42._s || this;
if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](v['$[]'](i))}, TMP_42._s = self, TMP_42), $a).call($b, 0))['$/'](self.n);
        m2 = ($a = ($c = inds).$inject, $a._p = (TMP_43 = function(e, i){var self = TMP_43._s || this;
if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](v['$[]'](i)['$**'](2))}, TMP_43._s = self, TMP_43), $a).call($c, 0)['$/'](self.n);
        return (m['$-'](mu))['$/'](Math.sqrt((m2['$-'](m['$**'](2)))/self.n['$-'](1)));
      };
      ...
      def.$sumOfSq_transf = function(v) {
        ...
        return ($a = ($b = v).$inject, $a._p = (TMP_44 = function(e, v2){var self = TMP_44._s || this;
if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](((v2['$-'](m))['$/'](s))['$**'](2))}, TMP_44._s = self, TMP_44), $a).call($b, 0);
      };
      ...
      def.$sumOfSq_transf_by_index = function(inds, v) {
        ...
        $a = [self.transf['$[]']("origDist").$mean(), self.transf['$[]']("origDist").$stdDev()], m = $a[0], s = $a[1];
        return ($a = ($b = inds).$inject, $a._p = (TMP_45 = function(e, i){var self = TMP_45._s || this;
if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](((v['$[]'](i)['$-'](m))['$/'](s))['$**'](2))}, TMP_45._s = self, TMP_45), $a).call($b, 0);
      };

      def.$seMean_transf = function(v) {
        var $a, $b, TMP_46, $c, TMP_47, self = this, m = nil, m2 = nil;

        m = (($a = ($b = v).$inject, $a._p = (TMP_46 = function(e, v2){var self = TMP_46._s || this;
if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2)}, TMP_46._s = self, TMP_46), $a).call($b, 0))['$/'](self.n);
        m2 = (($a = ($c = v).$inject, $a._p = (TMP_47 = function(e, v2){var self = TMP_47._s || this;
if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2['$**'](2))}, TMP_47._s = self, TMP_47), $a).call($c, 0))['$/'](self.n);
      ...
      def.$seMean_transf_by_index = function(inds, v) {
        ...
        m = (($a = ($b = inds).$inject, $a._p = (TMP_48 = function(e, i){var self = TMP_48._s || this;
if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](v['$[]'](i))}, TMP_48._s = self, TMP_48), $a).call($b, 0))['$/'](self.n);
        m2 = (($a = ($c = inds).$inject, $a._p = (TMP_49 = function(e, i){var self = TMP_49._s || this;
if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](v['$[]'](i)['$**'](2))}, TMP_49._s = self, TMP_49), $a).call($c, 0))['$/'](self.n);
        return Math.sqrt((m2['$-'](m['$**'](2)))/self.n['$-'](1));
      };
      ...
      def.$locationScale_transf = function(v) {
        ...
        return ($a = ($b = v).$map, $a._p = (TMP_50 = function(e){var self = TMP_50._s || this;
          if (self.transf == null) self.transf = nil;
if (e == null) e = nil;
        return self.transf['$[]']("args")['$[]'](0)['$+'](e['$*'](self.transf['$[]']("args")['$[]'](1)))}, TMP_50._s = self, TMP_50), $a).call($b);
      };

      def.$locationScale_transf_by_index = function(inds, v) {
        var $a, $b, TMP_51, self = this;

        return ($a = ($b = inds).$map, $a._p = (TMP_51 = function(i){var self = TMP_51._s || this;
          if (self.transf == null) self.transf = nil;
if (i == null) i = nil;
        return self.transf['$[]']("args")['$[]'](0)['$+'](v['$[]'](i)['$*'](self.transf['$[]']("args")['$[]'](1)))}, TMP_51._s = self, TMP_51), $a).call($b);
      };

      def.$square_transf = function(v) {
        var $a, $b, TMP_52, self = this;

        return ($a = ($b = v).$map, $a._p = (TMP_52 = function(e){var self = TMP_52._s || this;
if (e == null) e = nil;
        return e['$**'](2)}, TMP_52._s = self, TMP_52), $a).call($b);
      };

      def.$square_transf_by_index = function(inds, v) {
        var $a, $b, TMP_53, self = this;

        return ($a = ($b = inds).$map, $a._p = (TMP_53 = function(i){var self = TMP_53._s || this;
if (i == null) i = nil;
        return v['$[]'](i)['$**'](2)}, TMP_53._s = self, TMP_53), $a).call($b);
      };
      ...
      def.$transitionInitTransf = function(o, t) {
        ...
        if (self.$transfMode()['$==']("sample")) {
          self.ind = [];
          ($a = ($b = ($range(0, (self.x['$[]'](o).$length()['$/'](self.n)), true))).$each, $a._p = (TMP_54 = function(i){var self = TMP_54._s || this;
            if (self.ind == null) self.ind = nil;
if (i == null) i = nil;
          return self.ind['$<<']([])}, TMP_54._s = self, TMP_54), $a).call($b);
          ($a = ($c = ($range(0, self.x['$[]'](o).$length(), true))).$each, $a._p = (TMP_55 = function(i){var self = TMP_55._s || this;
            if (self.ind == null) self.ind = nil;
            if (self.n == null) self.n = nil;
if (i == null) i = nil;
          return self.ind['$[]']((i['$/'](self.n)).$floor())['$<<'](i)}, TMP_55._s = self, TMP_55), $a).call($c);
          ...
          self.col = [];
          ($a = ($d = self.ind).$each_with_index, $a._p = (TMP_56 = function(s, i){var self = TMP_56._s || this, $a, $b;
            if (self.x == null) self.x = nil;
...
if (s == null) s = nil;if (i == null) i = nil;
          self.x['$[]'](t)['$[]='](i, self.$applyTransfByIndex(s, self.x['$[]'](o)));
            ...
            if (self.statMode['$==']("ic")) {
              ...
              if ((($a = ($b = (self.x['$[]'](t)['$[]'](i)['$-'](self.icSide['$[]'](i))['$<='](mu)), $b !== false && $b !== nil ?(mu['$<='](self.x['$[]'](t)['$[]'](i)['$+'](self.icSide['$[]'](i)))) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
                self.icGood['$[]='](i, 1)};
              return self.cptIC = self.cptIC['$+'](self.icGood['$[]'](i));
              } else {
              return nil
            };}, TMP_56._s = self, TMP_56), $a).call($d);
          return self.y['$[]='](t, self.exp['$[]'](t).$y(self.x['$[]'](t)));
        } else if (self.$transfMode()['$==']("all")) {
          self.ind = ($a = ($e = ($range(0, self.x['$[]'](o).$length(), true))).$map, $a._p = (TMP_57 = function(i){var self = TMP_57._s || this;
if (i == null) i = nil;
          return [i]}, TMP_57._s = self, TMP_57), $a).call($e);
          self.x['$[]='](t, self.$applyTransfByValue(self.x['$[]'](o)));
          self.col = [[0, 0, 0, 1]]['$*']((self.x['$[]'](t).$length()));
          self.y['$[]='](t, self.exp['$[]'](t).$y(self.x['$[]'](t)));
          opdf = ($a = ($f = self.exp['$[]'](o).$distrib().$pdf(self.x['$[]'](o))).$map, $a._p = (TMP_58 = function(e){var self = TMP_58._s || this;
            if (self.exp == null) self.exp = nil;
if (e == null) e = nil;
          return e['$/'](self.exp['$[]'](o).$distrib().$step())}, TMP_58._s = self, TMP_58), $a).call($f);
          tpdf = ($a = ($g = self.exp['$[]'](t).$distrib().$pdf(self.x['$[]'](t))).$map, $a._p = (TMP_59 = function(e){var self = TMP_59._s || this;
            if (self.exp == null) self.exp = nil;
if (e == null) e = nil;
          return e['$/'](self.exp['$[]'](t).$distrib().$step())}, TMP_59._s = self, TMP_59), $a).call($g);
          return self.y['$[]='](t, ($a = ($h = ($range(0, self.x['$[]'](o).$length(), true))).$map, $a._p = (TMP_60 = function(i){var self = TMP_60._s || this;
            if (self.y == null) self.y = nil;
if (i == null) i = nil;
          return (self.y['$[]'](o)['$[]'](i))['$/'](opdf['$[]'](i))['$*'](tpdf['$[]'](i))}, TMP_60._s = self, TMP_60), $a).call($h));
          } else {
          return nil
        };
      };
      ...
      def.$transitionInitPts = function(cur) {
        ...
        return ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_61 = function(i){var self = TMP_61._s || this;
...
if (i == null) i = nil;
      ...
      def.$transitionInitPtsTransf = function(cur) {
        ...
        if (cur['$=='](0)) {
          return ($a = ($b = self.ind).$each_with_index, $a._p = (TMP_62 = function(s, i2){var self = TMP_62._s || this, $a, $b, TMP_63, col = nil;
            if (self.col == null) self.col = nil;
if (s == null) s = nil;if (i2 == null) i2 = nil;
          col = "rgba(" + (self.col['$[]'](i2)['$[]'](0)) + "," + (self.col['$[]'](i2)['$[]'](1)) + "," + (self.col['$[]'](i2)['$[]'](2)) + "," + (self.col['$[]'](i2)['$[]'](3)) + ")";
            return ($a = ($b = s).$each, $a._p = (TMP_63 = function(i){var self = TMP_63._s || this;
              if (self.style == null) self.style = nil;
              if (self.wX == null) self.wX = nil;
if (i == null) i = nil;
...
if (i == null) i = nil;
          col = "rgba(" + (self.col['$[]'](i)['$[]'](0)) + "," + (self.col['$[]'](i)['$[]'](1)) + "," + (self.col['$[]'](i)['$[]'](2)) + "," + (self.col['$[]'](i)['$[]'](3)) + ")";
            ...
            if (self.hist['$[]'](cur).$type()['$==']("disc")) {
              ...
              return nil
            };}, TMP_64._s = self, TMP_64), $a).call($c)
        };
      };
      ...
      def.$transitionInitExpRects = function(cur) {
        ...
        if ((($a = self.modeHidden) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          if (scale['$>'](1)) {
            scale = 1};};
        return ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_65 = function(i){var self = TMP_65._s || this, y = nil;
...
if (i == null) i = nil;
      ...
      def.$transitionInitRects = function(cur) {
        ...
        return ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_66 = function(i){var self = TMP_66._s || this;
...
if (i == null) i = nil;
      ...
      def.$transitionDrawPts = function(cur, wait) {
        ...
        ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_67 = function(i){var self = TMP_67._s || this, $a, $b, $c, y = nil, wait2 = nil;
          ...
          if (self.x == null) self.x = nil;
if (i == null) i = nil;
        y = (function() {if ((($a = self.modeHidden) !== nil && (!$a._isBoolean || $a == true))) {
            return self.yExpAxis['$[]'](0)
            } else {
            return self.graphExp.$to_Y(self.y['$[]'](cur)['$[]'](i))
          }; return nil; })();
          if ((($a = ($b = self.modeHidden, $b !== false && $b !== nil ?self.hist['$[]'](cur).$type()['$==']("disc") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            y = y['$-'](i['$*'](scale))};
          wait2 = wait;
      ...
      def.$transitionPtsTransf = function(t, merge, wait) {
        ...
        if ((($a = self.modeHidden) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          if (scale['$>'](1)) {
            scale = 1};};
        ($a = ($b = self.ind).$each_with_index, $a._p = (TMP_68 = function(s, i2){var self = TMP_68._s || this, $a, $b, TMP_69, col = nil, y = nil;
          if (self.col == null) self.col = nil;
          if (self.modeHidden == null) self.modeHidden = nil;
          if (self.yExpAxis == null) self.yExpAxis = nil;
          if (self.graphExp == null) self.graphExp = nil;
...
if (s == null) s = nil;if (i2 == null) i2 = nil;
        col = "rgba(" + (self.col['$[]'](i2)['$[]'](0)) + "," + (self.col['$[]'](i2)['$[]'](1)) + "," + (self.col['$[]'](i2)['$[]'](2)) + "," + (self.col['$[]'](i2)['$[]'](3)) + ")";
          ...
          if ((($a = ($b = self.modeHidden, $b !== false && $b !== nil ?self.hist['$[]'](t).$type()['$==']("disc") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
            y = y['$-'](i2['$*'](scale))};
          return ($a = ($b = s).$each, $a._p = (TMP_69 = function(i){var self = TMP_69._s || this, $a, $b, $c, wait2 = nil;
            if (self.modeHidden == null) self.modeHidden = nil;
            if (self.n == null) self.n = nil;
            if (self.remember == null) self.remember = nil;
            if (self.graphExp == null) self.graphExp = nil;
...
if (s == null) s = nil;if (i2 == null) i2 = nil;
        ...
        cur = 1;
        fall = fall['$+'](self.x['$[]'](cur).$length());
        ($a = ($c = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_76 = function(i){var self = TMP_76._s || this;
...
if (i == null) i = nil;
      ...
      def.$playShort = function(cur, duration) {
        ...
        self.$animMode();
        self.time = 0;
        if ((($a = ($b = self.transf, $b !== false && $b !== nil ?(((($c = self.transf['$[]']("dist")['$==']("exact")['$!']()) !== false && $c !== nil) ? $c : self.statMode['$==']("ic"))) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          x = [];
          if (self.statMode['$==']("ic")) {
...
if (i == null) i = nil;
          xx = self.exp['$[]'](0).$sample(self.n);
            ...
            if (self.statMode['$==']("ic")) {
              ...
              if ((($a = ($b = (x['$[]'](i)['$-'](icSide)['$<='](mu)), $b !== false && $b !== nil ?(mu['$<='](x['$[]'](i)['$+'](icSide))) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      def.$playLongDensity = function(duration) {
        ...
        if ((($a = self.transf) !== nil && (!$a._isBoolean || $a == true))) {
          if ((($a = self['$isModeHidden?']()) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        } else if ((($a = self['$isModeHidden?']()) !== nil && (!$a._isBoolean || $a == true))) {
    ...
    (function($base, $super) {
      ...
      def.$setAsTransfOf = function(dist, transf) {
        ...
        if ((($a = d.type === CONT) !== nil && (!$a._isBoolean || $a == true))) {
          return self.distrib = new Convolution(d,self.params['$[]'](0))
          } else {
          self.distrib = $scope.Convolution.$power(d, self.params['$[]'](0));
          return self.$p(["boundsDistrib", self.$step(), self.$bounds(), self.$pdf(self.$bounds()), ($a = ($b = self.$pdf(self.$bounds())).$inject, $a._p = (TMP_78 = function(e, e2){var self = TMP_78._s || this;
if (e == null) e = nil;if (e2 == null) e2 = nil;
          return e = e['$+'](e2)}, TMP_78._s = self, TMP_78), $a).call($b, 0)]);
        };}else { return nil }})();
      };
      ...
      def.$bounds = function() {
        ...
        qb = (function() {if ((($a = self.originalDistrib) !== nil && (!$a._isBoolean || $a == true))) {
          return self.originalDistrib.$qbounds()
          } else {
          return self.$qbounds()
        }; return nil; })();
        return (function() {$case = self.$type();if ("cont"['$===']($case)) {return ($a = ($b = qb).$map, $a._p = (TMP_79 = function(e){var self = TMP_79._s || this;
if (e == null) e = nil;
        return self.$quantile(e)}, TMP_79._s = self, TMP_79), $a).call($b)}else if ("disc"['$===']($case)) {if ((($a = self['$regular?']()) !== nil && (!$a._isBoolean || $a == true))) {
          $a = $opal.to_ary(($c = ($d = qb).$map, $c._p = (TMP_80 = function(e){var self = TMP_80._s || this;
if (e == null) e = nil;
          return self.$quantile(e)}, TMP_80._s = self, TMP_80), $c).call($d)), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]);
          s = self.$step();
          return ($a = ($c = $scope.Range.$new(0, ((b['$-'](a))['$/'](s))).$to_a()).$map, $a._p = (TMP_81 = function(e){var self = TMP_81._s || this;
if (e == null) e = nil;
          return a['$+'](e['$*'](s))}, TMP_81._s = self, TMP_81), $a).call($c);
          } else {
      ...
      def.$step = function() {
        ...
        if ((($a = self['$regular?']()) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          b = self.$bounds();
          return ($a = ($b = ($range(1, b.$length(), true))).$map, $a._p = (TMP_82 = function(i){var self = TMP_82._s || this;
if (i == null) i = nil;
          return (b['$[]'](i)['$-'](b['$[]'](i['$-'](1)))).$abs()}, TMP_82._s = self, TMP_82), $a).call($b).$min().$to_f();
        };
      };
    ...
    (function($base, $super) {
      ...
      $opal.defs($scope.Convolution, '$power', function(d, n) {
        ...
        if ((($a = d instanceof Distribution) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        ($a = ($b = ($range(1, n, true))).$each, $a._p = (TMP_83 = function(i){var self = TMP_83._s || this;
if (i == null) i = nil;
        dist2 = new Convolution2(dist,dist2,b,b2);
          return b2 = dist2.values();}, TMP_83._s = self, TMP_83), $a).call($b);
        return dist2;
      });
      ...
      return (def.$prepare = function() {
        ...
        ind = $hash2([], {});
        ($a = ($b = self.b1).$each_with_index, $a._p = (TMP_84 = function(v1, i1){var self = TMP_84._s || this, $a, $b, TMP_85;
...
if (v2 == null) v2 = nil;if (i2 == null) i2 = nil;
          v = $scope.CqlsAEP.$quantize(v1['$+'](v2));
            if ((($a = ind.$keys()['$include?'](v)) !== nil && (!$a._isBoolean || $a == true))) {
              ...
              return ind['$[]='](v, [[i1, i2]])
            };}, TMP_85._s = self, TMP_85), $a).call($b)}, TMP_84._s = self, TMP_84), $a).call($b);
        self.bounds = ind.$keys().$sort();
        self.pdf = [];
        return ($a = ($c = self.bounds).$each_with_index, $a._p = (TMP_86 = function(v, i){var self = TMP_86._s || this, $a, $b, TMP_87;
          if (self.pdf == null) self.pdf = nil;
if (v == null) v = nil;if (i == null) i = nil;
        self.pdf['$[]='](i, 0);
          return ($a = ($b = ind['$[]'](v)).$each, $a._p = (TMP_87 = function(j1, j2){var self = TMP_87._s || this, $a, $b;
            if (self.pdf == null) self.pdf = nil;
...
if (j1 == null) j1 = nil;if (j2 == null) j2 = nil;
          return ($a = i, $b = self.pdf, $b['$[]=']($a, $b['$[]']($a)['$+'](self.d1.density(self.b1['$[]'](j1))* self.d2.density(self.b2['$[]'](j2)))))}, TMP_87._s = self, TMP_87), $a).call($b);}, TMP_86._s = self, TMP_86), $a).call($c);
      }, nil) && 'prepare';
    })(self, null);
