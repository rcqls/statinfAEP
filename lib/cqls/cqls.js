...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$new', '$[]', '$addChild', '$<<', '$shape', '$plot=', '$graph=', '$add', '$>=', '$each', '$call', '$method', '$to_Y', '$+', '$*', '$-', '$<', '$[]=', '$empty?', '$xylim', '$zoom', '$syncedChildren', '$synced?', '$select', '$include?', '$min', '$map', '$==', '$max', '$/', '$update', '$===', '$id', '$each_key', '$showZoom', '$>', '$to_s', '$length', '$initStep', '$seq', '$dim', '$to_X', '$mean', '$maxPdf', '$stdDev', '$sample', '$pdf', '$type', '$map!', '$step', '$y', '$to_f', '$abs', '$set', '$initDistrib', '$setAsTransfOf', '$regular?', '$bounds', '$initXYLim', '$adjust', '$drawCont', '$drawDisc', '$**', '$init', '$draw', '$distrib', '$each_with_index', '$floor', '$quantize', '$updateBounds', '$reset', '$drawCurve', '$<=', '$index', '$inject', '$acceptLevelNext', '$dup', '$counts', '$density', '$partBounds', '$graph', '$syncTo', '$setDistrib', '$style', '$attachCurve', '$attachSummary', '$marg', '$attachExpAxis', '$setAlpha', '$setStatMode', '$isModeHidden?', '$setTransf', '$setMLevel', '$setN', '$active=', '$setCurHist', '$setTCL', '$updateTCL', '$updateVisible', '$style=', '$variance', '$setDistribAs', '$setDistribAsTransf', '$xy', '$setNbSim', '$p', '$initTransfList', '$name', '$setTransfDistrib', '$-@', '$transfMode', '$quantile', '$applyTransfByIndex', '$seMean_transf_by_index', '$applyTransfByValue', '$allowLevelChange', '$updateHistAEP', '$aep', '$hideAll', '$drawSummary', '$incCptIC', '$drawMean', '$drawSD', '$seMean_transf', '$cptICTot=', '$cptICTot', '$playNextAfter', '$addXY', '$transitionInitHist', '$transitionInitPts', '$transitionInitRects', '$transitionInitTime', '$transitionDrawPts', '$transitionFallPts', '$transitionHistPtsAndRects', '$transitionInitExpRects', '$transitionExpPtsAndRects', '$transitionDrawRectsHidden', '$transitionHistPtsAndRectsHidden', '$transitionInitTransf', '$transitionInitPtsTransf', '$transitionPtsTransf', '$transitionDrawIC', '$animMode', '$playLongDensityWithTransfHidden', '$playLongDensityForIC', '$playLongDensityWithTransf', '$playLongDensityBasicHidden', '$playLongDensityBasic', '$join', '$power', '$qbounds', '$to_a', '$prepare', '$keys', '$sort']);
...
if (i == null) i = nil;
      ...
      return (def.$updateHistAEP = function(x, mode) {
        var $a, $b, TMP_30, $c, TMP_31, $d, TMP_32, $e, TMP_33, self = this, $case = nil;
        if (mode == null) {
          mode = "normal"
        }
        ...
        self.aep['$[]=']("nbTot", ((function() {if (($a = (["normal", "reduced"]['$include?'](mode))) !== false && $a !== nil) {
          return self.nbTot
          } else {
          return 0
        }; return nil; })())['$+'](x.$length()));
        $a = [[], []], self.aep['$[]=']("xRect", $a[0]), self.aep['$[]=']("yRect", $a[1]);
        $case = self.type;if ("cont"['$===']($case)) {($a = ($b = x).$each_with_index, $a._p = (TMP_30 = function(e, i){var self = TMP_30._s || this, $a, $b, pos = nil;
          if (self.bounds == null) self.bounds = nil;
...
if (e == null) e = nil;if (i == null) i = nil;
        if (($a = (($b = self.bounds['$[]'](0)['$<='](e)) ? e['$<='](self.bounds['$[]'](-1)) : $b)) !== false && $a !== nil) {
          ...
          }}, TMP_30._s = self, TMP_30), $a).call($b)}else if ("disc"['$===']($case)) {($a = ($c = x).$each_with_index, $a._p = (TMP_31 = function(e, i){var self = TMP_31._s || this, $a, $b, pos = nil;
          if (self.bounds == null) self.bounds = nil;
          if (self.aep == null) self.aep = nil;
if (e == null) e = nil;if (i == null) i = nil;
        pos = self.$index(e);
          if (($a = (($b = (0)['$<='](pos)) ? pos['$<'](self.bounds.$length()) : $b)) !== false && $a !== nil) {
            ...
            return self.aep['$[]']("yRect")['$[]='](i, 0);
          };}, TMP_31._s = self, TMP_31), $a).call($c)};
        if (mode['$==']("new")) {
          self.aep['$[]=']("mean", [(($a = ($d = x).$inject, $a._p = (TMP_32 = function(e, e2){var self = TMP_32._s || this;if (e == null) e = nil;if (e2 == null) e2 = nil;
          return e = e['$+'](e2)}, TMP_32._s = self, TMP_32), $a).call($d, 0))['$/'](self.aep['$[]']("nbTot")), (($a = ($e = x).$inject, $a._p = (TMP_33 = function(e, e2){var self = TMP_33._s || this;if (e == null) e = nil;if (e2 == null) e2 = nil;
          return e = e['$+'](e2['$**'](2))}, TMP_33._s = self, TMP_33), $a).call($e, 0))['$/'](self.aep['$[]']("nbTot"))]);
    ...
    (function($base, $super) {
      ...
      def.plotExp = def.plotHist = def.graphHist = def.graphExp = def.exp = def.hist = def.ratioExpAxis = def.transf = def.checkTCL = def.n = def.x = def.y = def.statMode = def.modeHidden = def.mLevel = def.mLevels = def.nold = def.transfList = def.curIndHist = def.histCur = def.n01 = def.alpha = def.ind = def.aep = def.w = def.h = def.wX = def.hY = def.time = def.cptIC = def.nbSim = nil;
      ...
      def.$reset = function(curs) {
        ...
        self.plotExp.$update();
        ($a = ($b = curs).$each, $a._p = (TMP_34 = function(cur){var self = TMP_34._s || this;
...
if (cur == null) cur = nil;
        self.hist['$[]'](cur).$reset();
          ...
          return self.hist['$[]'](cur).$draw();}, TMP_34._s = self, TMP_34), $a).call($b);
      ...
      def.$updateTCL = function(state) {
        ...
        if (($a = ($b = self.transf, $b !== false && $b !== nil ?(["mean", "sum", "stdMean"]['$include?'](self.transf['$[]']("name"))) : $b)) === false || $a === nil) {
          state = false};
      ...
      def.$setDistrib = function(name, params, cur) {
        ...
        if (($a = params) === false || $a === nil) {
          ...
          params = [10]}}else if ("exp"['$===']($case)) {if (($a = params) === false || $a === nil) {
          params = [1]}}else if ("cauchy"['$===']($case)) {if (($a = params) === false || $a === nil) {
          params = [0, 1]}}else if ("saljus"['$===']($case)) {self.$setDistribAs($scope.Distribution.$new("exp", [1], $hash2(["name", "args"], {"name": "locationScale", "args": [90, 10]})));
        to_set = false;};
      ...
      def.$setStatMode = function(transf) {
        ...
        self['$isModeHidden?']();
        return self.$p(["setStatMode", transf, self.statMode, self.modeHidden]);
      };
      ...
      def.$animMode = function() {
        var $a, self = this;
        cqls.i.anim=cqls.enyo.app.$.animMode.getValue();
        cqls.i.prior=cqls.enyo.app.$.priorMode.getValue();
        console.log(cqls.i.anim + ":"+ cqls.i.prior);
        if (($a = cqls.i.anim) !== false && $a !== nil) {
          if (($a = cqls.i.prior) !== false && $a !== nil) {
            return "prior"
            } else {
            return "normal"
          }
      ...
      def.$sum_transf = function(v) {
        ...
        return e = e['$+'](v2)}, TMP_35._s = self, TMP_35), $a).call($b, 0);
      };
      ...
      def.$sum_transf_by_index = function(inds, v) {
        ...
        return e = e['$+'](v['$[]'](i))}, TMP_36._s = self, TMP_36), $a).call($b, 0);
      };

      def.$mean_transf = function(v) {
        var $a, $b, TMP_37, self = this;
        return (($a = ($b = v).$inject, $a._p = (TMP_37 = function(e, v2){var self = TMP_37._s || this;if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2)}, TMP_37._s = self, TMP_37), $a).call($b, 0))['$/'](self.n);
      };

      def.$mean_transf_by_index = function(inds, v) {
        var $a, $b, TMP_38, self = this;
        return (($a = ($b = inds).$inject, $a._p = (TMP_38 = function(e, i){var self = TMP_38._s || this;if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](v['$[]'](i))}, TMP_38._s = self, TMP_38), $a).call($b, 0))['$/'](self.n);
      };

      def.$stdMean_transf = function(v, mu) {
        var $a, $b, TMP_39, $c, TMP_40, self = this, m = nil, m2 = nil;
        m = (($a = ($b = v).$inject, $a._p = (TMP_39 = function(e, v2){var self = TMP_39._s || this;if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2)}, TMP_39._s = self, TMP_39), $a).call($b, 0))['$/'](self.n);
        m2 = (($a = ($c = v).$inject, $a._p = (TMP_40 = function(e, v2){var self = TMP_40._s || this;if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2['$**'](2))}, TMP_40._s = self, TMP_40), $a).call($c, 0))['$/'](self.n);
        return (m['$-'](mu))['$/'](Math.sqrt((m2['$-'](m['$**'](2)))/self.n['$-'](1)));
      };

      def.$stdMean_transf_by_index = function(inds, v, mu) {
        var $a, $b, TMP_41, $c, TMP_42, self = this, m = nil, m2 = nil;
        m = (($a = ($b = inds).$inject, $a._p = (TMP_41 = function(e, i){var self = TMP_41._s || this;if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](v['$[]'](i))}, TMP_41._s = self, TMP_41), $a).call($b, 0))['$/'](self.n);
        m2 = ($a = ($c = inds).$inject, $a._p = (TMP_42 = function(e, i){var self = TMP_42._s || this;if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](v['$[]'](i)['$**'](2))}, TMP_42._s = self, TMP_42), $a).call($c, 0)['$/'](self.n);
        return (m['$-'](mu))['$/'](Math.sqrt((m2['$-'](m['$**'](2)))/self.n['$-'](1)));
      };

      def.$sumOfSq_transf = function(v) {
        var $a, $b, TMP_43, self = this, m = nil, s = nil;
        $a = [self.transf['$[]']("origDist").$mean(), self.transf['$[]']("origDist").$stdDev()], m = $a[0], s = $a[1];
        return ($a = ($b = v).$inject, $a._p = (TMP_43 = function(e, v2){var self = TMP_43._s || this;if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](((v2['$-'](m))['$/'](s))['$**'](2))}, TMP_43._s = self, TMP_43), $a).call($b, 0);
      };

      def.$sumOfSq_transf_by_index = function(inds, v) {
        var $a, $b, TMP_44, self = this, m = nil, s = nil;
        $a = [self.transf['$[]']("origDist").$mean(), self.transf['$[]']("origDist").$stdDev()], m = $a[0], s = $a[1];
        return ($a = ($b = inds).$inject, $a._p = (TMP_44 = function(e, i){var self = TMP_44._s || this;if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](((v['$[]'](i)['$-'](m))['$/'](s))['$**'](2))}, TMP_44._s = self, TMP_44), $a).call($b, 0);
      };

      def.$seMean_transf = function(v) {
        var $a, $b, TMP_45, $c, TMP_46, self = this, m = nil, m2 = nil;
        m = (($a = ($b = v).$inject, $a._p = (TMP_45 = function(e, v2){var self = TMP_45._s || this;if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2)}, TMP_45._s = self, TMP_45), $a).call($b, 0))['$/'](self.n);
        m2 = (($a = ($c = v).$inject, $a._p = (TMP_46 = function(e, v2){var self = TMP_46._s || this;if (e == null) e = nil;if (v2 == null) v2 = nil;
        return e = e['$+'](v2['$**'](2))}, TMP_46._s = self, TMP_46), $a).call($c, 0))['$/'](self.n);
        return Math.sqrt((m2['$-'](m['$**'](2)))/self.n['$-'](1));
      };

      def.$seMean_transf_by_index = function(inds, v) {
        var $a, $b, TMP_47, $c, TMP_48, self = this, m = nil, m2 = nil;
        m = (($a = ($b = inds).$inject, $a._p = (TMP_47 = function(e, i){var self = TMP_47._s || this;if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](v['$[]'](i))}, TMP_47._s = self, TMP_47), $a).call($b, 0))['$/'](self.n);
        m2 = (($a = ($c = inds).$inject, $a._p = (TMP_48 = function(e, i){var self = TMP_48._s || this;if (e == null) e = nil;if (i == null) i = nil;
        return e = e['$+'](v['$[]'](i)['$**'](2))}, TMP_48._s = self, TMP_48), $a).call($c, 0))['$/'](self.n);
        return Math.sqrt((m2['$-'](m['$**'](2)))/self.n['$-'](1));
      };

      def.$locationScale_transf = function(v) {
        var $a, $b, TMP_49, self = this;
        return ($a = ($b = v).$map, $a._p = (TMP_49 = function(e){var self = TMP_49._s || this;
          if (self.transf == null) self.transf = nil;
if (e == null) e = nil;
        return self.transf['$[]']("args")['$[]'](0)['$+'](e['$*'](self.transf['$[]']("args")['$[]'](1)))}, TMP_49._s = self, TMP_49), $a).call($b);
      };

      def.$locationScale_transf_by_index = function(inds, v) {
        var $a, $b, TMP_50, self = this;
        return ($a = ($b = inds).$map, $a._p = (TMP_50 = function(i){var self = TMP_50._s || this;
          if (self.transf == null) self.transf = nil;
if (i == null) i = nil;
        return self.transf['$[]']("args")['$[]'](0)['$+'](v['$[]'](i)['$*'](self.transf['$[]']("args")['$[]'](1)))}, TMP_50._s = self, TMP_50), $a).call($b);
      };

      def.$square_transf = function(v) {
        var $a, $b, TMP_51, self = this;
        return ($a = ($b = v).$map, $a._p = (TMP_51 = function(e){var self = TMP_51._s || this;if (e == null) e = nil;
        return e['$**'](2)}, TMP_51._s = self, TMP_51), $a).call($b);
      };

      def.$square_transf_by_index = function(inds, v) {
        var $a, $b, TMP_52, self = this;
        return ($a = ($b = inds).$map, $a._p = (TMP_52 = function(i){var self = TMP_52._s || this;if (i == null) i = nil;
        return v['$[]'](i)['$**'](2)}, TMP_52._s = self, TMP_52), $a).call($b);
      };
      ...
      def.$transitionInitTransf = function(o, t) {
        var $a, $b, TMP_53, $c, TMP_54, $d, TMP_55, $e, TMP_56, $f, TMP_57, $g, TMP_58, $h, TMP_59, self = this, q = nil, mu = nil, opdf = nil, tpdf = nil;
        if (o == null) {
          o = 0
        }
        if (t == null) {
        ...
        if (self.$transfMode()['$==']("sample")) {
          self.ind = [];
          ($a = ($b = ($range(0, (self.x['$[]'](o).$length()['$/'](self.n)), true))).$each, $a._p = (TMP_53 = function(i){var self = TMP_53._s || this;
            if (self.ind == null) self.ind = nil;
if (i == null) i = nil;
          return self.ind['$<<']([])}, TMP_53._s = self, TMP_53), $a).call($b);
          ($a = ($c = ($range(0, self.x['$[]'](o).$length(), true))).$each, $a._p = (TMP_54 = function(i){var self = TMP_54._s || this;
            if (self.ind == null) self.ind = nil;
            if (self.n == null) self.n = nil;
if (i == null) i = nil;
          return self.ind['$[]']((i['$/'](self.n)).$floor())['$<<'](i)}, TMP_54._s = self, TMP_54), $a).call($c);
          ...
          self.col = [];
          ($a = ($d = self.ind).$each_with_index, $a._p = (TMP_55 = function(s, i){var self = TMP_55._s || this, $a, $b;
            if (self.x == null) self.x = nil;
...
if (s == null) s = nil;if (i == null) i = nil;
          self.x['$[]'](t)['$[]='](i, self.$applyTransfByIndex(s, self.x['$[]'](o)));
            ...
            if (self.statMode['$==']("ic")) {
              ...
              if (($a = ($b = (self.x['$[]'](t)['$[]'](i)['$-'](self.icSide['$[]'](i))['$<='](mu)), $b !== false && $b !== nil ?(mu['$<='](self.x['$[]'](t)['$[]'](i)['$+'](self.icSide['$[]'](i)))) : $b)) !== false && $a !== nil) {
                self.icGood['$[]='](i, 1)};
              return self.cptIC = self.cptIC['$+'](self.icGood['$[]'](i));
              } else {
              return nil
            };}, TMP_55._s = self, TMP_55), $a).call($d);
          return self.y['$[]='](t, self.exp['$[]'](t).$y(self.x['$[]'](t)));
        } else if (self.$transfMode()['$==']("all")) {
          self.ind = ($a = ($e = ($range(0, self.x['$[]'](o).$length(), true))).$map, $a._p = (TMP_56 = function(i){var self = TMP_56._s || this;if (i == null) i = nil;
          return [i]}, TMP_56._s = self, TMP_56), $a).call($e);
          self.x['$[]='](t, self.$applyTransfByValue(self.x['$[]'](o)));
          self.col = [[0, 0, 0, 1]]['$*']((self.x['$[]'](t).$length()));
          self.y['$[]='](t, self.exp['$[]'](t).$y(self.x['$[]'](t)));
          opdf = ($a = ($f = self.exp['$[]'](o).$distrib().$pdf(self.x['$[]'](o))).$map, $a._p = (TMP_57 = function(e){var self = TMP_57._s || this;
            if (self.exp == null) self.exp = nil;
if (e == null) e = nil;
          return e['$/'](self.exp['$[]'](o).$distrib().$step())}, TMP_57._s = self, TMP_57), $a).call($f);
          tpdf = ($a = ($g = self.exp['$[]'](t).$distrib().$pdf(self.x['$[]'](t))).$map, $a._p = (TMP_58 = function(e){var self = TMP_58._s || this;
            if (self.exp == null) self.exp = nil;
if (e == null) e = nil;
          return e['$/'](self.exp['$[]'](t).$distrib().$step())}, TMP_58._s = self, TMP_58), $a).call($g);
          return self.y['$[]='](t, ($a = ($h = ($range(0, self.x['$[]'](o).$length(), true))).$map, $a._p = (TMP_59 = function(i){var self = TMP_59._s || this;
            if (self.y == null) self.y = nil;
if (i == null) i = nil;
          return (self.y['$[]'](o)['$[]'](i))['$/'](opdf['$[]'](i))['$*'](tpdf['$[]'](i))}, TMP_59._s = self, TMP_59), $a).call($h));
          } else {
          return nil
        };
      };
      ...
      def.$transitionInitPts = function(cur) {
        ...
        return ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_60 = function(i){var self = TMP_60._s || this;
...
if (i == null) i = nil;
      ...
      def.$transitionInitPtsTransf = function(cur) {
        var $a, $b, TMP_61, $c, TMP_63, self = this;
        if (($a = self.transf['$[]']("mode")['$==']("sample")) === false || $a === nil) {
          return nil};
        if (cur['$=='](0)) {
          return ($a = ($b = self.ind).$each_with_index, $a._p = (TMP_61 = function(s, i2){var self = TMP_61._s || this, $a, $b, TMP_62, col = nil;
            if (self.col == null) self.col = nil;
if (s == null) s = nil;if (i2 == null) i2 = nil;
          col = "rgba(" + (self.col['$[]'](i2)['$[]'](0)) + "," + (self.col['$[]'](i2)['$[]'](1)) + "," + (self.col['$[]'](i2)['$[]'](2)) + "," + (self.col['$[]'](i2)['$[]'](3)) + ")";
            return ($a = ($b = s).$each, $a._p = (TMP_62 = function(i){var self = TMP_62._s || this;
              if (self.style == null) self.style = nil;
              if (self.wX == null) self.wX = nil;
if (i == null) i = nil;
						...
						;}, TMP_62._s = self, TMP_62), $a).call($b);}, TMP_61._s = self, TMP_61), $a).call($b)
          } else {
          return ($a = ($c = ($range(0, self.x['$[]'](cur).$length(), true))).$each_with_index, $a._p = (TMP_63 = function(i){var self = TMP_63._s || this, col = nil;
            if (self.col == null) self.col = nil;
            if (self.style == null) self.style = nil;
            if (self.hist == null) self.hist = nil;
            if (self.wX == null) self.wX = nil;
if (i == null) i = nil;
          col = "rgba(" + (self.col['$[]'](i)['$[]'](0)) + "," + (self.col['$[]'](i)['$[]'](1)) + "," + (self.col['$[]'](i)['$[]'](2)) + "," + (self.col['$[]'](i)['$[]'](3)) + ")";
            ...
            if (self.hist['$[]'](cur).$type()['$==']("disc")) {
              ...
              return nil
            };}, TMP_63._s = self, TMP_63), $a).call($c)
        };
      };
      ...
      def.$transitionInitExpRects = function(cur) {
        var $a, $b, TMP_64, self = this, scale = nil;
        if (($a = self.modeHidden) !== false && $a !== nil) {
          scale = (self.graphExp.$dim()['$[]']("h")['$*'](0.2))['$/']((self.x['$[]'](cur).$length()));
          if (scale['$>'](1)) {
            scale = 1};};
        return ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_64 = function(i){var self = TMP_64._s || this, y = nil;
...
if (i == null) i = nil;
      ...
      def.$transitionInitRects = function(cur) {
        ...
        return ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_65 = function(i){var self = TMP_65._s || this;
...
if (i == null) i = nil;
      ...
      def.$transitionDrawPts = function(cur, wait) {
        var $a, $b, TMP_66, self = this, scale = nil;
        if (wait == null) {
        ...
        ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_66 = function(i){var self = TMP_66._s || this, $a, $b, $c, y = nil, wait2 = nil;
          ...
          if (self.x == null) self.x = nil;
if (i == null) i = nil;
        y = (function() {if (($a = self.modeHidden) !== false && $a !== nil) {
            return self.yExpAxis['$[]'](0)
            } else {
            return self.graphExp.$to_Y(self.y['$[]'](cur)['$[]'](i))
          }; return nil; })();
          if (($a = ($b = self.modeHidden, $b !== false && $b !== nil ?self.hist['$[]'](cur).$type()['$==']("disc") : $b)) !== false && $a !== nil) {
            y = y['$-'](i['$*'](scale))};
          wait2 = wait;
          if (($a = ($b = ($c = self.modeHidden, $c !== false && $c !== nil ?cur['$=='](0) : $c), $b !== false && $b !== nil ?self.transf : $b)) !== false && $a !== nil) {
            wait2 = wait2['$-'](i['$*'](self.remember['$[]']("lag")))};
					...
					.wait(wait2)
				;
          if (($a = (($b = self.hist['$[]'](cur).$type()['$==']("disc")) ? ($c = self.modeHidden, ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
      ...
      def.$transitionPtsTransf = function(t, merge, wait) {
        ...
        if (($a = self.modeHidden) !== false && $a !== nil) {
          ...
          if (scale['$>'](1)) {
            scale = 1};};
        ($a = ($b = self.ind).$each_with_index, $a._p = (TMP_67 = function(s, i2){var self = TMP_67._s || this, $a, $b, TMP_68, col = nil, y = nil;
          if (self.col == null) self.col = nil;
          if (self.modeHidden == null) self.modeHidden = nil;
          if (self.yExpAxis == null) self.yExpAxis = nil;
          if (self.graphExp == null) self.graphExp = nil;
...
if (s == null) s = nil;if (i2 == null) i2 = nil;
        col = "rgba(" + (self.col['$[]'](i2)['$[]'](0)) + "," + (self.col['$[]'](i2)['$[]'](1)) + "," + (self.col['$[]'](i2)['$[]'](2)) + "," + (self.col['$[]'](i2)['$[]'](3)) + ")";
          ...
          if (($a = ($b = self.modeHidden, $b !== false && $b !== nil ?self.hist['$[]'](t).$type()['$==']("disc") : $b)) !== false && $a !== nil) {
            y = y['$-'](i2['$*'](scale))};
          return ($a = ($b = s).$each, $a._p = (TMP_68 = function(i){var self = TMP_68._s || this, $a, $b, $c, wait2 = nil;
            if (self.modeHidden == null) self.modeHidden = nil;
            if (self.n == null) self.n = nil;
            if (self.remember == null) self.remember = nil;
            if (self.graphExp == null) self.graphExp = nil;
...
if (i == null) i = nil;
          wait2 = wait;
            if (($a = self.modeHidden) !== false && $a !== nil) {
              wait2 = wait2['$-']((self.n['$-'](i))['$*'](self.remember['$[]']("lag")))};
						...
						if(($a = ($b = ($c = self.transf, $c !== false && $c !== nil ?self.hist['$[]'](0).$type()['$==']("disc") : $c), $b !== false && $b !== nil ?self.hist['$[]'](1).$type()['$==']("disc") : $b), $a !== false && $a !== nil ?($b = self.modeHidden, ($b === nil || $b === false)) : $a)) {
					 		cqls.tweens.line[i].call(function(tween) {
					...
					;}, TMP_68._s = self, TMP_68), $a).call($b);}, TMP_67._s = self, TMP_67), $a).call($b);
      ...
      def.$transitionFallPts = function(cur, fall, wait) {
        ...
        ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_69 = function(i){var self = TMP_69._s || this;
          if (self.plotHist == null) self.plotHist = nil;
          if (self.hist == null) self.hist = nil;
if (i == null) i = nil;
          ...
          if (self.hist['$[]'](cur).$type()['$==']("disc")) {
            ...
            return nil
          };}, TMP_69._s = self, TMP_69), $a).call($b);
...
if (i == null) i = nil;
				...
				;}, TMP_70._s = self, TMP_70), $a).call($b);
...
if (i == null) i = nil;
				...
				;}, TMP_72._s = self, TMP_72), $a).call($b);
...
if (i == null) i = nil;
      ...
      def.$transitionDrawIC = function(from, wait, pause, before, fall, after) {
        var $a, $b, TMP_74, $c, TMP_75, self = this, cur = nil;
        if (from == null) {
          from = self.time
        }
        if (wait == null) {
        ...
        ($a = ($b = self.ind).$each_with_index, $a._p = (TMP_74 = function(s, i2){var self = TMP_74._s || this, col = nil, y = nil, l = nil;
          if (self.col == null) self.col = nil;
          if (self.graphExp == null) self.graphExp = nil;
          if (self.y == null) self.y = nil;
          if (self.icSide == null) self.icSide = nil;
...
if (s == null) s = nil;if (i2 == null) i2 = nil;
        ...
        cur = 1;
        fall = fall['$+'](self.x['$[]'](cur).$length());
        ($a = ($c = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_75 = function(i){var self = TMP_75._s || this;
...
if (i == null) i = nil;
				...
				;}, TMP_75._s = self, TMP_75), $a).call($c);
      ...
      def.$drawSummary = function(cur) {
        ...
        return state = cqls.enyo.app.$.checkSummary.getValue();
      };

      def.$updateVisible = function() {
        var $a, self = this, isTransf = nil, isSample = nil, state = nil;
        ...
        self.exp['$[]'](0).summaryShapes[0].visible=cqls.enyo.app.$.checkExp0Mean.getValue();
        self.exp['$[]'](0).summaryShapes[1].visible=cqls.enyo.app.$.checkExp0SD.getValue();
        self.exp['$[]'](1).summaryShapes[0].visible=isTransf & cqls.enyo.app.$.checkExp1Mean.getValue();
        self.exp['$[]'](1).summaryShapes[1].visible=isTransf & cqls.enyo.app.$.checkExp1SD.getValue();
        self.histCur.summaryShapes[0].visible=cqls.enyo.app.$.checkHistMean.getValue();
        self.histCur.summaryShapes[1].visible=cqls.enyo.app.$.checkHistSD.getValue();
        self.$updateTCL(cqls.enyo.app.$.checkTCL.getValue());
        return cqls.m.stage.update();
      };

      def.$playShort = function(cur, duration) {
        var $a, $b, $c, $d, TMP_76, self = this, x = nil, q = nil, mu = nil;
        if (cur == null) {
          cur = self.curIndHist
        }
        if (duration == null) {
        ...
        self.$hideAll(cur);
        self.time = 0;
        if (($a = ($b = self.transf, $b !== false && $b !== nil ?(((($c = ($d = self.transf['$[]']("dist")['$==']("exact"), ($d === nil || $d === false))) !== false && $c !== nil) ? $c : self.statMode['$==']("ic"))) : $b)) !== false && $a !== nil) {
          x = [];
          if (self.statMode['$==']("ic")) {
            $a = [self.n01.$quantile((1)['$-'](self.alpha['$/'](2))), self.exp['$[]'](0).$distrib().$mean()], q = $a[0], mu = $a[1]};
          ($a = ($b = ($range(0, ((10)['$**'](cqls.i.count)), true))).$each, $a._p = (TMP_76 = function(i){var self = TMP_76._s || this, $a, $b, xx = nil, icSide = nil;
            if (self.exp == null) self.exp = nil;
            if (self.n == null) self.n = nil;
            if (self.statMode == null) self.statMode = nil;
            if (self.hist == null) self.hist = nil;
if (i == null) i = nil;
          xx = self.exp['$[]'](0).$sample(self.n);
            ...
            if (self.statMode['$==']("ic")) {
              ...
              if (($a = ($b = (x['$[]'](i)['$-'](icSide)['$<='](mu)), $b !== false && $b !== nil ?(mu['$<='](x['$[]'](i)['$+'](icSide))) : $b)) !== false && $a !== nil) {
              ...
              return nil
            };}, TMP_76._s = self, TMP_76), $a).call($b);
          self.hist['$[]'](cur).$add(x);
          } else {
    ...
    (function($base, $super) {
      ...
      def.$setAsTransfOf = function(dist, transf) {
        var $a, $b, TMP_77, self = this, $case = nil, d = nil;
        ...
        if (($a = d.type === CONT) !== false && $a !== nil) {
          ...
          return self.$p(["boundsDistrib", self.$step(), self.$bounds(), self.$pdf(self.$bounds()), ($a = ($b = self.$pdf(self.$bounds())).$inject, $a._p = (TMP_77 = function(e, e2){var self = TMP_77._s || this;if (e == null) e = nil;if (e2 == null) e2 = nil;
          return e = e['$+'](e2)}, TMP_77._s = self, TMP_77), $a).call($b, 0)]);
        };}else { return nil }})();
      };
      ...
      def.$bounds = function() {
        var $a, $b, TMP_78, $c, $d, TMP_79, TMP_80, self = this, qb = nil, $case = nil, a = nil, b = nil, s = nil;
        qb = (function() {if (($a = self.originalDistrib) !== false && $a !== nil) {
          return self.originalDistrib.$qbounds()
          } else {
          return self.$qbounds()
        }; return nil; })();
        return (function() {$case = self.$type();if ("cont"['$===']($case)) {return ($a = ($b = qb).$map, $a._p = (TMP_78 = function(e){var self = TMP_78._s || this;if (e == null) e = nil;
        return self.$quantile(e)}, TMP_78._s = self, TMP_78), $a).call($b)}else if ("disc"['$===']($case)) {if (($a = self['$regular?']()) !== false && $a !== nil) {
          $a = $opal.to_ary(($c = ($d = qb).$map, $c._p = (TMP_79 = function(e){var self = TMP_79._s || this;if (e == null) e = nil;
          return self.$quantile(e)}, TMP_79._s = self, TMP_79), $c).call($d)), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]);
          s = self.$step();
          return ($a = ($c = $scope.Range.$new(0, ((b['$-'](a))['$/'](s))).$to_a()).$map, $a._p = (TMP_80 = function(e){var self = TMP_80._s || this;if (e == null) e = nil;
          return a['$+'](e['$*'](s))}, TMP_80._s = self, TMP_80), $a).call($c);
          } else {
      ...
      def.$step = function() {
        var $a, $b, TMP_81, self = this, b = nil;
        if (($a = self['$regular?']()) !== false && $a !== nil) {
          return self.distrib.step();
          } else {
          b = self.$bounds();
          return ($a = ($b = ($range(1, b.$length(), true))).$map, $a._p = (TMP_81 = function(i){var self = TMP_81._s || this;if (i == null) i = nil;
          return (b['$[]'](i)['$-'](b['$[]'](i['$-'](1)))).$abs()}, TMP_81._s = self, TMP_81), $a).call($b).$min().$to_f();
        };
      };
    ...
    (function($base, $super) {
      ...
      $opal.defs($scope.Convolution, '$power', function(d, n) {
        var $a, $b, TMP_82, self = this, dist = nil, b = nil, dist2 = nil, b2 = nil;
        ...
        ($a = ($b = ($range(1, n, true))).$each, $a._p = (TMP_82 = function(i){var self = TMP_82._s || this;if (i == null) i = nil;
        dist2 = new Convolution2(dist,dist2,b,b2);
          return b2 = dist2.values();}, TMP_82._s = self, TMP_82), $a).call($b);
        return dist2;
      });
      ...
      return (def.$prepare = function() {
        var $a, $b, TMP_83, $c, TMP_85, self = this, ind = nil;
        ind = $hash2([], {});
        ($a = ($b = self.b1).$each_with_index, $a._p = (TMP_83 = function(v1, i1){var self = TMP_83._s || this, $a, $b, TMP_84;
          if (self.b2 == null) self.b2 = nil;
if (v1 == null) v1 = nil;if (i1 == null) i1 = nil;
        return ($a = ($b = self.b2).$each_with_index, $a._p = (TMP_84 = function(v2, i2){var self = TMP_84._s || this, $a, v = nil;if (v2 == null) v2 = nil;if (i2 == null) i2 = nil;
          v = $scope.Cqls.$quantize(v1['$+'](v2));
            if (($a = ind.$keys()['$include?'](v)) !== false && $a !== nil) {
              return ind['$[]'](v)['$<<']([i1, i2])
              } else {
              return ind['$[]='](v, [[i1, i2]])
            };}, TMP_84._s = self, TMP_84), $a).call($b)}, TMP_83._s = self, TMP_83), $a).call($b);
        self.bounds = ind.$keys().$sort();
        self.pdf = [];
        return ($a = ($c = self.bounds).$each_with_index, $a._p = (TMP_85 = function(v, i){var self = TMP_85._s || this, $a, $b, TMP_86;
          if (self.pdf == null) self.pdf = nil;
if (v == null) v = nil;if (i == null) i = nil;
        self.pdf['$[]='](i, 0);
          return ($a = ($b = ind['$[]'](v)).$each, $a._p = (TMP_86 = function(j1, j2){var self = TMP_86._s || this, $a, $b;
            if (self.pdf == null) self.pdf = nil;
...
if (j1 == null) j1 = nil;if (j2 == null) j2 = nil;
          return ($a = i, $b = self.pdf, $b['$[]=']($a, $b['$[]']($a)['$+'](self.d1.density(self.b1['$[]'](j1))* self.d2.density(self.b2['$[]'](j2)))))}, TMP_86._s = self, TMP_86), $a).call($b);}, TMP_85._s = self, TMP_85), $a).call($c);
      }, nil);
    })(self, null);
