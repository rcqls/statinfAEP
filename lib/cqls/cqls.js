...
(function($opal) {
  ...
  $opal.add_stubs(['$transitionFallPts', '$xy', '$keys', '$to_s', '$<=', '$method', '$aep', '$density', '$style=', '$transitionDrawRectsHidden', '$setMLevel', '$isModeHidden?', '$quantize', '$setDistrib', '$transitionInitHist', '$to_X', '$transitionHistPtsAndRectsHidden', '$acceptLevelNext', '$floor', '$>=', '$attachExpAxis', '$attr_accessor', '$seq', '$reset', '$distrib', '$show', '$id', '$transitionInitTime', '$transfMode', '$attachSummary', '$inject', '$partBounds', '$drawCont', '$power', '$transitionInitExpRects', '$drawCurve', '$maxPdf', '$marg', '$playLongDensityBasic', '$addXY', '$style', '$each_key', '$===', '$quantile', '$transitionPtsTransf', '$<<', '$adjust', '$sample', '$playLongDensityWithTransfHidden', '$graph=', '$allowLevelChange', '$==', '$min', '$>', '$qbounds', '$name', '$initTransfList', '$addChild', '$[]=', '$p', '$hideAll', '$showZoom', '$setN', '$attachCurve', '$transitionInitPts', '$synced?', '$transitionHistPtsAndRects', '$setCurHist', '$setAsTransfOf', '$[]', '$transitionInitPtsTransf', '$drawMean', '$init', '$add', '$to_Y', '$showExpAxis', '$**', '$type', '$step', '$bounds', '$<', '$to_f', '$y', '$include?', '$syncedChildren', '$join', '$playNextAfter', '$drawDisc', '$syncTo', '$showTCL', '$graph', '$dup', '$/', '$transitionInitRects', '$-@', '$playLongDensityBasicHidden', '$setNbSim', '$pdf', '$applyTransfByIndex', '$updateBounds', '$to_a', '$update', '$regular?', '$transitionExpPtsAndRects', '$length', '$abs', '$initDistrib', '$max', '$transitionInitTransf', '$call', '$set', '$-', '$drawSummary', '$setDistribAs', '$shape', '$select', '$setDistribAsTransf', '$each_with_index', '$setTCL', '$counts', '$drawSD', '$map', '$xylim', '$showSummary', '$new', '$variance', '$index', '$initXYLim', '$prepare', '$plot=', '$mean', '$map!', '$zoom', '$setTransf', '$+', '$empty?', '$draw', '$setTransfDistrib', '$dim', '$transitionDrawPts', '$applyTransfByValue', '$active=', '$stdDev', '$sort', '$playLongDensityWithTransf', '$each', '$initStep', '$*', '$updateHistAEP']);
...
if (e == null) e = nil;if (i == null) i = nil;
    ...
    (function($base, $super) {
      ...
      def.plotExp = def.plotHist = def.graphHist = def.graphExp = def.exp = def.hist = def.ratioExpAxis = def.transf = def.checkTCL = def.n = def.stage = def.x = def.y = def.mLevel = def.mLevels = def.nold = def.transfList = def.curIndHist = def.histCur = def.ind = def.aep = def.w = def.h = def.wX = def.hY = def.modeHidden = def.time = def.nbSim = nil;
...
if (cur == null) cur = nil;
      ...
      def.$setTCL = function() {
        ...
        self.checkTCL.$setDistrib("normal", [self.exp['$[]'](0).$distrib().$mean(), Math.sqrt(self.exp['$[]'](0).$distrib().$variance()['$/'](self.n))]);
...
if (i == null) i = nil;
      ...
      def.$showExpAxis = function() {
        ...
        return self.exp['$[]'](1).expAxisShape.visible= false;
      };
