...
if (e == null) e = nil;if (i == null) i = nil;
    ...
    (function($base, $super) {
      ...
      def.plotExp = def.plotHist = def.graphHist = def.graphExp = def.exp = def.hist = def.ratioExpAxis = def.transf = def.checkTCL = def.n = def.x = def.y = def.mLevel = def.mLevels = def.nold = def.transfList = def.curIndHist = def.histCur = def.ind = def.aep = def.w = def.h = def.wX = def.hY = def.modeHidden = def.time = def.nbSim = nil;
...
if (cur == null) cur = nil;
      ...
      def.$locationScale_transf = function(v) {
        ...
        return ($a = ($b = v).$map, $a._p = (TMP_45 = function(e){var self = TMP_45._s || this;
          if (self.transf == null) self.transf = nil;
if (e == null) e = nil;
        return self.transf['$[]']("args")['$[]'](0)['$+'](e['$*'](self.transf['$[]']("args")['$[]'](1)))}, TMP_45._s = self, TMP_45), $a).call($b);
      };

      def.$locationScale_transf_by_index = function(inds, v) {
        var $a, $b, TMP_46, self = this;
        return ($a = ($b = inds).$map, $a._p = (TMP_46 = function(i){var self = TMP_46._s || this;
          if (self.transf == null) self.transf = nil;
if (i == null) i = nil;
        return self.transf['$[]']("args")['$[]'](0)['$+'](v['$[]'](i)['$*'](self.transf['$[]']("args")['$[]'](1)))}, TMP_46._s = self, TMP_46), $a).call($b);
      };

      def.$square_transf = function(v) {
        var $a, $b, TMP_47, self = this;
        return ($a = ($b = v).$map, $a._p = (TMP_47 = function(e){var self = TMP_47._s || this;if (e == null) e = nil;
        return e['$**'](2)}, TMP_47._s = self, TMP_47), $a).call($b);
      };

      def.$square_transf_by_index = function(inds, v) {
        var $a, $b, TMP_48, self = this;
        return ($a = ($b = inds).$map, $a._p = (TMP_48 = function(i){var self = TMP_48._s || this;if (i == null) i = nil;
        return v['$[]'](i)['$**'](2)}, TMP_48._s = self, TMP_48), $a).call($b);
      };
      ...
      def.$transitionInitTransf = function(o, t) {
        var $a, $b, TMP_49, $c, TMP_50, $d, TMP_51, $e, TMP_52, $f, TMP_53, $g, TMP_54, $h, TMP_55, self = this, opdf = nil, tpdf = nil;
        if (o == null) {
          o = 0
        }
        if (t == null) {
        ...
        if (self.$transfMode()['$==']("sample")) {
          self.ind = [];
          ($a = ($b = ($range(0, (self.x['$[]'](o).$length()['$/'](self.n)), true))).$each, $a._p = (TMP_49 = function(i){var self = TMP_49._s || this;
            if (self.ind == null) self.ind = nil;
if (i == null) i = nil;
          return self.ind['$<<']([])}, TMP_49._s = self, TMP_49), $a).call($b);
          ($a = ($c = ($range(0, self.x['$[]'](o).$length(), true))).$each, $a._p = (TMP_50 = function(i){var self = TMP_50._s || this;
            if (self.ind == null) self.ind = nil;
            if (self.n == null) self.n = nil;
if (i == null) i = nil;
          return self.ind['$[]']((i['$/'](self.n)).$floor())['$<<'](i)}, TMP_50._s = self, TMP_50), $a).call($c);
          self.x['$[]='](t, [0]['$*']((self.x['$[]'](o).$length()['$/'](self.n))));
          self.col = [];
          ($a = ($d = self.ind).$each_with_index, $a._p = (TMP_51 = function(s, i){var self = TMP_51._s || this;
            if (self.x == null) self.x = nil;
            if (self.col == null) self.col = nil;
if (s == null) s = nil;if (i == null) i = nil;
          self.x['$[]'](t)['$[]='](i, self.$applyTransfByIndex(s, self.x['$[]'](o)));
            return self.col['$[]='](i, [(Math.random()*256).$floor(), (Math.random()*256).$floor(), (Math.random()*256).$floor(), 0.8]);}, TMP_51._s = self, TMP_51), $a).call($d);
          return self.y['$[]='](t, self.exp['$[]'](t).$y(self.x['$[]'](t)));
        } else if (self.$transfMode()['$==']("all")) {
          self.ind = ($a = ($e = ($range(0, self.x['$[]'](o).$length(), true))).$map, $a._p = (TMP_52 = function(i){var self = TMP_52._s || this;if (i == null) i = nil;
          return [i]}, TMP_52._s = self, TMP_52), $a).call($e);
          self.x['$[]='](t, self.$applyTransfByValue(self.x['$[]'](o)));
          self.col = [[0, 0, 0, 1]]['$*']((self.x['$[]'](t).$length()));
          self.y['$[]='](t, self.exp['$[]'](t).$y(self.x['$[]'](t)));
          opdf = ($a = ($f = self.exp['$[]'](o).$distrib().$pdf(self.x['$[]'](o))).$map, $a._p = (TMP_53 = function(e){var self = TMP_53._s || this;
            if (self.exp == null) self.exp = nil;
if (e == null) e = nil;
          return e['$/'](self.exp['$[]'](o).$distrib().$step())}, TMP_53._s = self, TMP_53), $a).call($f);
          tpdf = ($a = ($g = self.exp['$[]'](t).$distrib().$pdf(self.x['$[]'](t))).$map, $a._p = (TMP_54 = function(e){var self = TMP_54._s || this;
            if (self.exp == null) self.exp = nil;
if (e == null) e = nil;
          return e['$/'](self.exp['$[]'](t).$distrib().$step())}, TMP_54._s = self, TMP_54), $a).call($g);
          return self.y['$[]='](t, ($a = ($h = ($range(0, self.x['$[]'](o).$length(), true))).$map, $a._p = (TMP_55 = function(i){var self = TMP_55._s || this;
            if (self.y == null) self.y = nil;
if (i == null) i = nil;
          return (self.y['$[]'](o)['$[]'](i))['$/'](opdf['$[]'](i))['$*'](tpdf['$[]'](i))}, TMP_55._s = self, TMP_55), $a).call($h));
          } else {
          return nil
        };
      };
      ...
      def.$transitionInitPts = function(cur) {
        ...
        return ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_56 = function(i){var self = TMP_56._s || this;
...
if (i == null) i = nil;
      ...
      def.$transitionInitPtsTransf = function(cur) {
        var $a, $b, TMP_57, $c, TMP_59, self = this;
        if (($a = self.transf['$[]']("mode")['$==']("sample")) === false || $a === nil) {
          return nil};
        if (cur['$=='](0)) {
          return ($a = ($b = self.ind).$each_with_index, $a._p = (TMP_57 = function(s, i2){var self = TMP_57._s || this, $a, $b, TMP_58, col = nil;
            if (self.col == null) self.col = nil;
if (s == null) s = nil;if (i2 == null) i2 = nil;
          col = "rgba(" + (self.col['$[]'](i2)['$[]'](0)) + "," + (self.col['$[]'](i2)['$[]'](1)) + "," + (self.col['$[]'](i2)['$[]'](2)) + "," + (self.col['$[]'](i2)['$[]'](3)) + ")";
            return ($a = ($b = s).$each, $a._p = (TMP_58 = function(i){var self = TMP_58._s || this;
              if (self.style == null) self.style = nil;
              if (self.wX == null) self.wX = nil;
if (i == null) i = nil;
						...
						;}, TMP_58._s = self, TMP_58), $a).call($b);}, TMP_57._s = self, TMP_57), $a).call($b)
          } else {
          return ($a = ($c = ($range(0, self.x['$[]'](cur).$length(), true))).$each_with_index, $a._p = (TMP_59 = function(i){var self = TMP_59._s || this, col = nil;
            if (self.col == null) self.col = nil;
            if (self.style == null) self.style = nil;
            if (self.hist == null) self.hist = nil;
            if (self.wX == null) self.wX = nil;
if (i == null) i = nil;
          col = "rgba(" + (self.col['$[]'](i)['$[]'](0)) + "," + (self.col['$[]'](i)['$[]'](1)) + "," + (self.col['$[]'](i)['$[]'](2)) + "," + (self.col['$[]'](i)['$[]'](3)) + ")";
            ...
            if (self.hist['$[]'](cur).$type()['$==']("disc")) {
              ...
              return nil
            };}, TMP_59._s = self, TMP_59), $a).call($c)
        };
      };
      ...
      def.$transitionInitExpRects = function(cur) {
        var $a, $b, TMP_60, self = this, scale = nil;
        if (($a = self.modeHidden) !== false && $a !== nil) {
          scale = (self.graphExp.$dim()['$[]']("h")['$*'](0.2))['$/']((self.x['$[]'](cur).$length()));
          if (scale['$>'](1)) {
            scale = 1};};
        return ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_60 = function(i){var self = TMP_60._s || this, y = nil;
...
if (i == null) i = nil;
      ...
      def.$transitionDrawPts = function(cur, wait) {
        var $a, $b, TMP_62, self = this, scale = nil;
        if (wait == null) {
        ...
        if (($a = self.modeHidden) !== false && $a !== nil) {
          ...
          if (scale['$>'](1)) {
            scale = 1};};
        ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_62 = function(i){var self = TMP_62._s || this, $a, $b, $c, y = nil;
...
if (i == null) i = nil;
      ...
      def.$transitionPtsTransf = function(t, merge, wait) {
        var $a, $b, TMP_63, self = this, scale = nil;
        if (t == null) {
          t = 1
        }
        if (merge == null) {
        ...
        if (($a = self.modeHidden) !== false && $a !== nil) {
          ...
          if (scale['$>'](1)) {
            scale = 1};};
        ($a = ($b = self.ind).$each_with_index, $a._p = (TMP_63 = function(s, i2){var self = TMP_63._s || this, $a, $b, TMP_64, col = nil, y = nil;
          if (self.col == null) self.col = nil;
          if (self.modeHidden == null) self.modeHidden = nil;
          if (self.yExpAxis == null) self.yExpAxis = nil;
          if (self.graphExp == null) self.graphExp = nil;
...
if (s == null) s = nil;if (i2 == null) i2 = nil;
        col = "rgba(" + (self.col['$[]'](i2)['$[]'](0)) + "," + (self.col['$[]'](i2)['$[]'](1)) + "," + (self.col['$[]'](i2)['$[]'](2)) + "," + (self.col['$[]'](i2)['$[]'](3)) + ")";
          ...
          if (($a = ($b = self.modeHidden, $b !== false && $b !== nil ?self.hist['$[]'](t).$type()['$==']("disc") : $b)) !== false && $a !== nil) {
            y = y['$-'](i2['$*'](scale))};
          return ($a = ($b = s).$each, $a._p = (TMP_64 = function(i){var self = TMP_64._s || this, $a, $b, $c;
            if (self.graphExp == null) self.graphExp = nil;
            if (self.x == null) self.x = nil;
            if (self.modeHidden == null) self.modeHidden = nil;
            if (self.transf == null) self.transf = nil;
...
if (i == null) i = nil;
					...
					;}, TMP_64._s = self, TMP_64), $a).call($b);}, TMP_63._s = self, TMP_63), $a).call($b);
      ...
      def.$transitionFallPts = function(cur, fall, wait) {
        ...
        ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_65 = function(i){var self = TMP_65._s || this;
          if (self.plotHist == null) self.plotHist = nil;
          if (self.hist == null) self.hist = nil;
if (i == null) i = nil;
      ...
      def.$transitionExpPtsAndRects = function(cur, from, before, fall, after) {
        ...
        ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_66 = function(i){var self = TMP_66._s || this;
          if (self.graphExp == null) self.graphExp = nil;
          if (self.aep == null) self.aep = nil;
          if (self.hY == null) self.hY = nil;
if (i == null) i = nil;
      ...
      def.$transitionDrawRectsHidden = function(cur, from, after) {
        ...
        ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_67 = function(i){var self = TMP_67._s || this;
          if (self.graphExp == null) self.graphExp = nil;
          if (self.aep == null) self.aep = nil;
          if (self.hY == null) self.hY = nil;
          if (self.hist == null) self.hist = nil;
...
if (i == null) i = nil;
      ...
      def.$transitionHistPtsAndRectsHidden = function(cur, from, before, fall, after) {
        ...
        fall = fall['$+'](self.x['$[]'](cur).$length());
        ($a = ($b = ($range(0, self.x['$[]'](cur).$length(), true))).$each, $a._p = (TMP_68 = function(i){var self = TMP_68._s || this;
          if (self.graphHist == null) self.graphHist = nil;
          if (self.aep == null) self.aep = nil;
          if (self.hY == null) self.hY = nil;
if (i == null) i = nil;
...
if (i == null) i = nil;
      ...
      def.$playShort = function(cur, duration) {
        ...
        if (($a = ($b = self.transf, $b !== false && $b !== nil ?($c = self.transf['$[]']("dist")['$==']("exact"), ($c === nil || $c === false)) : $b)) !== false && $a !== nil) {
          x = [];
          ($a = ($b = ($range(0, ((10)['$**'](cqls.i.count)), true))).$each, $a._p = (TMP_70 = function(i){var self = TMP_70._s || this;
            if (self.exp == null) self.exp = nil;
            if (self.n == null) self.n = nil;
if (i == null) i = nil;
          return x['$[]='](i, self.$applyTransfByValue(self.exp['$[]'](0).$sample(self.n)))}, TMP_70._s = self, TMP_70), $a).call($b);
          self.hist['$[]'](cur).$add(x);
          } else {
    ...
    (function($base, $super) {
      ...
      def.$setAsTransfOf = function(dist, transf) {
        var $a, $b, TMP_71, self = this, $case = nil, d = nil;
        ...
        if (($a = d.type === CONT) !== false && $a !== nil) {
          ...
          return self.$p(["boundsDistrib", self.$step(), self.$bounds(), self.$pdf(self.$bounds()), ($a = ($b = self.$pdf(self.$bounds())).$inject, $a._p = (TMP_71 = function(e, e2){var self = TMP_71._s || this;if (e == null) e = nil;if (e2 == null) e2 = nil;
          return e = e['$+'](e2)}, TMP_71._s = self, TMP_71), $a).call($b, 0)]);
        };}else { return nil }})();
      };
      ...
      def.$bounds = function() {
        var $a, $b, TMP_72, $c, $d, TMP_73, TMP_74, self = this, qb = nil, $case = nil, a = nil, b = nil, s = nil;
        qb = (function() {if (($a = self.originalDistrib) !== false && $a !== nil) {
          return self.originalDistrib.$qbounds()
          } else {
          return self.$qbounds()
        }; return nil; })();
        return (function() {$case = self.$type();if ("cont"['$===']($case)) {return ($a = ($b = qb).$map, $a._p = (TMP_72 = function(e){var self = TMP_72._s || this;if (e == null) e = nil;
        return self.$quantile(e)}, TMP_72._s = self, TMP_72), $a).call($b)}else if ("disc"['$===']($case)) {if (($a = self['$regular?']()) !== false && $a !== nil) {
          $a = $opal.to_ary(($c = ($d = qb).$map, $c._p = (TMP_73 = function(e){var self = TMP_73._s || this;if (e == null) e = nil;
          return self.$quantile(e)}, TMP_73._s = self, TMP_73), $c).call($d)), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]);
          s = self.$step();
          return ($a = ($c = $scope.Range.$new(0, ((b['$-'](a))['$/'](s))).$to_a()).$map, $a._p = (TMP_74 = function(e){var self = TMP_74._s || this;if (e == null) e = nil;
          return a['$+'](e['$*'](s))}, TMP_74._s = self, TMP_74), $a).call($c);
          } else {
      ...
      def.$step = function() {
        var $a, $b, TMP_75, self = this, b = nil;
        if (($a = self['$regular?']()) !== false && $a !== nil) {
          return self.distrib.step();
          } else {
          b = self.$bounds();
          return ($a = ($b = ($range(1, b.$length(), true))).$map, $a._p = (TMP_75 = function(i){var self = TMP_75._s || this;if (i == null) i = nil;
          return (b['$[]'](i)['$-'](b['$[]'](i['$-'](1)))).$abs()}, TMP_75._s = self, TMP_75), $a).call($b).$min().$to_f();
        };
      };
    ...
    (function($base, $super) {
      ...
      $opal.defs($scope.Convolution, '$power', function(d, n) {
        var $a, $b, TMP_76, self = this, dist = nil, b = nil, dist2 = nil, b2 = nil;
        ...
        ($a = ($b = ($range(1, n, true))).$each, $a._p = (TMP_76 = function(i){var self = TMP_76._s || this;if (i == null) i = nil;
        dist2 = new Convolution2(dist,dist2,b,b2);
          return b2 = dist2.values();}, TMP_76._s = self, TMP_76), $a).call($b);
        return dist2;
      });
      ...
      return (def.$prepare = function() {
        var $a, $b, TMP_77, $c, TMP_79, self = this, ind = nil;
        ind = $hash2([], {});
        ($a = ($b = self.b1).$each_with_index, $a._p = (TMP_77 = function(v1, i1){var self = TMP_77._s || this, $a, $b, TMP_78;
          if (self.b2 == null) self.b2 = nil;
if (v1 == null) v1 = nil;if (i1 == null) i1 = nil;
        return ($a = ($b = self.b2).$each_with_index, $a._p = (TMP_78 = function(v2, i2){var self = TMP_78._s || this, $a, v = nil;if (v2 == null) v2 = nil;if (i2 == null) i2 = nil;
          v = $scope.Cqls.$quantize(v1['$+'](v2));
            if (($a = ind.$keys()['$include?'](v)) !== false && $a !== nil) {
              return ind['$[]'](v)['$<<']([i1, i2])
              } else {
              return ind['$[]='](v, [[i1, i2]])
            };}, TMP_78._s = self, TMP_78), $a).call($b)}, TMP_77._s = self, TMP_77), $a).call($b);
        self.bounds = ind.$keys().$sort();
        self.pdf = [];
        return ($a = ($c = self.bounds).$each_with_index, $a._p = (TMP_79 = function(v, i){var self = TMP_79._s || this, $a, $b, TMP_80;
          if (self.pdf == null) self.pdf = nil;
if (v == null) v = nil;if (i == null) i = nil;
        self.pdf['$[]='](i, 0);
          return ($a = ($b = ind['$[]'](v)).$each, $a._p = (TMP_80 = function(j1, j2){var self = TMP_80._s || this, $a, $b;
            if (self.pdf == null) self.pdf = nil;
...
if (j1 == null) j1 = nil;if (j2 == null) j2 = nil;
          return ($a = i, $b = self.pdf, $b['$[]=']($a, $b['$[]']($a)['$+'](self.d1.density(self.b1['$[]'](j1))* self.d2.density(self.b2['$[]'](j2)))))}, TMP_80._s = self, TMP_80), $a).call($b);}, TMP_79._s = self, TMP_79), $a).call($c);
      }, nil);
    })(self, null);
