...
if (k == null) k = nil;if (v == null) v = nil;
        args = v['$[]'](2);
          ...
          return ($a = v['$[]'](0).$method(v['$[]'](1))).$call.apply($a, Opal.to_a(args));}, TMP_2.$$s = self, TMP_2), $a).call($b);
      });
...
if (k == null) k = nil;
        self.zoomShapes['$[]'](k).alpha=0.5;
          return (function() {$case = k;if ("xposmore"['$===']($case)) {return self.zoomShapes['$[]']("xposmore").graphics.c().s("#000").f("#FFF").mt(self.dim['$[]']("w")-1.5*size,$rb_divide(self.dim['$[]']("h"), 2.0)-$rb_divide(size, 2)).lt(self.dim['$[]']("w")-1.5*size,$rb_divide(self.dim['$[]']("h"), 2.0)+$rb_divide(size, 2)).lt(self.dim['$[]']("w")-0.5*size,$rb_divide(self.dim['$[]']("h"), 2.0)).cp() ;}else if ("xposless"['$===']($case)) {return self.zoomShapes['$[]']("xposless").graphics.c().s("#000").f("#FFF").mt(self.dim['$[]']("w")-1.5*size-inter,$rb_divide(self.dim['$[]']("h"), 2.0)-$rb_divide(size, 2)).lt(self.dim['$[]']("w")-1.5*size-inter,$rb_divide(self.dim['$[]']("h"), 2.0)+$rb_divide(size, 2)).lt(self.dim['$[]']("w")-2.5*size-inter,$rb_divide(self.dim['$[]']("h"), 2.0)).cp() ;}else if ("xnegmore"['$===']($case)) {return self.zoomShapes['$[]']("xnegmore").graphics.c().s("#000").f("#FFF").mt(1.5*size,$rb_divide(self.dim['$[]']("h"), 2.0)-$rb_divide(size, 2)).lt(1.5*size,$rb_divide(self.dim['$[]']("h"), 2.0)+$rb_divide(size, 2)).lt(0.5*size,$rb_divide(self.dim['$[]']("h"), 2.0)).cp() ;}else if ("xnegless"['$===']($case)) {return self.zoomShapes['$[]']("xnegless").graphics.c().s("#000").f("#FFF").mt(1.5*size+inter,$rb_divide(self.dim['$[]']("h"), 2.0)-$rb_divide(size, 2)).lt(1.5*size+inter,$rb_divide(self.dim['$[]']("h"), 2.0)+$rb_divide(size, 2)).lt(2.5*size+inter,$rb_divide(self.dim['$[]']("h"), 2.0)).cp() ;}else if ("ynegmore"['$===']($case)) {return self.zoomShapes['$[]']("ynegmore").graphics.c().s("#000").f("#FFF").mt($rb_divide(self.dim['$[]']("w"), 2.0)-$rb_divide(size, 2),self.dim['$[]']("h")-1.5*size).lt($rb_divide(self.dim['$[]']("w"), 2.0)+$rb_divide(size, 2),self.dim['$[]']("h")-1.5*size).lt($rb_divide(self.dim['$[]']("w"), 2.0),self.dim['$[]']("h")-0.5*size).cp() ;}else if ("ynegless"['$===']($case)) {return self.zoomShapes['$[]']("ynegless").graphics.c().s("#000").f("#FFF").mt($rb_divide(self.dim['$[]']("w"), 2.0)-$rb_divide(size, 2),self.dim['$[]']("h")-1.5*size-inter).lt($rb_divide(self.dim['$[]']("w"), 2.0)+$rb_divide(size, 2),self.dim['$[]']("h")-1.5*size-inter).lt($rb_divide(self.dim['$[]']("w"), 2.0),self.dim['$[]']("h")-2.5*size-inter).cp() ;}else if ("yposmore"['$===']($case)) {return self.zoomShapes['$[]']("yposmore").graphics.c().s("#000").f("#FFF").mt($rb_divide(self.dim['$[]']("w"), 2.0)-$rb_divide(size, 2),1.5*size).lt($rb_divide(self.dim['$[]']("w"), 2.0)+$rb_divide(size, 2),1.5*size).lt($rb_divide(self.dim['$[]']("w"), 2.0),0.5*size).cp() ;}else if ("yposless"['$===']($case)) {return self.zoomShapes['$[]']("yposless").graphics.c().s("#000").f("#FFF").mt($rb_divide(self.dim['$[]']("w"), 2.0)-$rb_divide(size, 2),1.5*size+inter).lt($rb_divide(self.dim['$[]']("w"), 2.0)+$rb_divide(size, 2),1.5*size+inter).lt($rb_divide(self.dim['$[]']("w"), 2.0),2.5*size+inter).cp() ;}else if ("reset"['$===']($case)) {return self.zoomShapes['$[]']("reset").graphics.c().s("#000").f("#FFF").drawRect($rb_divide(self.dim['$[]']("w"), 2.0)-$rb_divide(size, 2), $rb_divide(self.dim['$[]']("h"), 2.0)-$rb_divide(size, 2),size,size) ;}else { return nil }})();}, TMP_12.$$s = self, TMP_12), $a).call($b);
      });
...
if (v == null) v = nil;
          args = v['$[]'](2);
            ...
            return ($a = v['$[]'](0).$method(v['$[]'](1))).$call.apply($a, Opal.to_a(args));}, TMP_20.$$s = self, TMP_20), $a).call($b)
          } else {
          return nil
        };
      });
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_21 = function(type, params) {
...
if (e == null) e = nil;if (e2 == null) e2 = nil;
          return e = $rb_plus(e, e2)}, TMP_26.$$s = self, TMP_26), $a).call($b, 0)]);
        };}else { return nil }})();
      });
      ...
      Opal.defn(self, '$bounds', function() {
        var $a, $b, TMP_27, $c, $d, $e, TMP_28, TMP_29, self = this, qb = nil, $case = nil, a = nil, b = nil, s = nil;
...
if (e == null) e = nil;
        return self.$quantile(e)}, TMP_27.$$s = self, TMP_27), $a).call($b)}else if ("disc"['$===']($case)) {if ((($a = self['$regular?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          $c = ($d = ($e = qb).$map, $d.$$p = (TMP_28 = function(e){var self = TMP_28.$$s || this;
if (e == null) e = nil;
          return self.$quantile(e)}, TMP_28.$$s = self, TMP_28), $d).call($e), $a = Opal.to_ary($c), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]), $c;
          s = self.$step();
          return ($a = ($c = $scope.get('Range').$new(0, ($rb_divide(($rb_minus(b, a)), s))).$to_a()).$map, $a.$$p = (TMP_29 = function(e){var self = TMP_29.$$s || this;
if (e == null) e = nil;
          return $rb_plus(a, $rb_times(e, s))}, TMP_29.$$s = self, TMP_29), $a).call($c);
          } else {
...
if (i == null) i = nil;
          return ($rb_minus(b['$[]'](i), b['$[]']($rb_minus(i, 1)))).$abs()}, TMP_30.$$s = self, TMP_30), $a).call($b).$min().$to_f();
        };
      });
...
if (j1 == null) j1 = nil;if (j2 == null) j2 = nil;
          return ($a = i, $b = self.pdf, $b['$[]=']($a, $rb_plus($b['$[]']($a), self.d1.density(self.b1['$[]'](j1))* self.d2.density(self.b2['$[]'](j2)))))}, TMP_35.$$s = self, TMP_35), $a).call($b);}, TMP_34.$$s = self, TMP_34), $a).call($c);
      }), nil) && 'prepare';
    })($scope.base, null);
