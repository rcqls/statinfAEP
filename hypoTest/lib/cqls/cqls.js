...
(function($opal) {
  ...
  $opal.add_stubs(['$paramsFrame', '$plot=', '$drawSD', '$cdf', '$keys', '$dim', '$to_s', '$<=', '$method', '$initXYLim', '$style=', '$setStatMode', '$mean', '$draw', '$adjust', '$stdDev', '$>=', '$attr_accessor', '$sdStyle=', '$seq', '$reset', '$id', '$alpha=', '$inject', '$getContext', '$initEvents', '$setDistrib', '$synced?', '$style', '$each_key', '$===', '$<<', '$to_x', '$distrib', '$getSides', '$==', '$attachShapes', '$min', '$>', '$setPval', '$syncedChildren', '$[]=', '$drawCont', '$maxPdf', '$typeStatTest=', '$p', '$graph=', '$setStyles', '$sample', '$[]', '$drawAreaSide', '$add', '$initStep', '$addChild', '$type', '$step', '$<', '$to_f', '$to_X', '$y', '$include?', '$attachAxis', '$join', '$/', '$setAlphaFromQuantile', '$addCallable', '$to_Y', '$tooltipContent', '$nil?', '$setAsTransfOf', '$quantize', '$setPlot', '$drawMean', '$xylim', '$setAlpha', '$typeStatTest', '$to_a', '$update', '$bounds', '$qbounds', '$graph', '$zoom', '$quantile', '$length', '$setParamsFrame', '$abs', '$max', '$call', '$set', '$-', '$drawDisc', '$active=', '$paramsFrame=', '$meanStyle=', '$select', '$pdf', '$each_with_index', '$updateStatTestDistrib', '$regular?', '$map', '$new', '$include', '$initDistrib', '$showZoom', '$map!', '$prepare', '$+', '$empty?', '$updateVisible', '$shape', '$playCallables', '$power', '$sort', '$each', '$*', '$initTooltip']);
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(dim, style) {
        ...
        self.graph = ($scope.CqlsHypo)._scope.Graph.$new(self.dim);
        self.updateCalls = [];
...
if (k == null) k = nil;
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(id, type, bounds, length) {
        ...
        self.x = $scope.CqlsHypo.$seq(self.bounds['$[]'](0), self.bounds['$[]'](1), self.length);
        self.kind = "density";
...
if (i == null) i = nil;
      ...
      def.$initDistrib = function() {
        ...
        $case = self.type;if ("cont"['$===']($case)) {self.x = $scope.CqlsHypo.$seq(self.bounds['$[]'](0), self.bounds['$[]'](1), self.length)}else if ("disc"['$===']($case)) {self.$initStep();
        self.x = self.bounds;};
...
if (side == null) side = nil;if (i == null) i = nil;
    ...
    (function($base, $super) {
      ...
      def.$getContext = function() {
        ...
        self.context['$[]=']("param", cqlsHypo.enyo.app.$.paramMenuName.getContent());
        self.context['$[]=']("side", cqlsHypo.enyo.app.$.sideMenuName.getContent());
        self.context['$[]=']("ref", parseFloat(cqlsHypo.enyo.app.$.refValue.getValue()));
        self.context['$[]=']("n", parseInt(cqlsHypo.enyo.app.$.nValue.getValue()));
        ...
        self.context['$[]=']("paramEstLim", parseFloat(cqlsHypo.enyo.app.$.meanValue.getValue()));
        ...
        self.context['$[]=']("paramEstLim", parseFloat(cqlsHypo.enyo.app.$.meanValue.getValue()));
        sd = parseFloat(cqlsHypo.enyo.app.$.sdValue.getValue());
...
if (cur == null) cur = nil;
      ...
      return (def.$updateVisible = function() {
        var self = this;
				...
				self.paramEst['$[]'](0).shape.visible=cqlsHypo.enyo.app.$.checkParam0Curve.getValue();
				self.paramEst['$[]'](1).shape.visible=cqlsHypo.enyo.app.$.checkParam1Curve.getValue();
				self.deltaEst['$[]'](0).shape.visible=cqlsHypo.enyo.app.$.checkDelta0Curve.getValue();
				self.deltaEst['$[]'](1).shape.visible=cqlsHypo.enyo.app.$.checkDelta1Curve.getValue();
			 	

				// Lim
				self.paramLim.shapes[0].visible= cqlsHypo.enyo.app.$.checkParamLim.getValue();
				self.paramLim.shapes[1].visible= cqlsHypo.enyo.app.$.checkParamLim.getValue();
				self.deltaLim.shapes[0].visible= cqlsHypo.enyo.app.$.checkDeltaLim.getValue();
				self.deltaLim.shapes[1].visible= cqlsHypo.enyo.app.$.checkDeltaLim.getValue();
				self.paramEstLim.shapes[0].visible= cqlsHypo.enyo.app.$.checkData.getValue();
				self.paramEstLim.shapes[1].visible= cqlsHypo.enyo.app.$.checkData.getValue();
				self.deltaEstLim.shapes[0].visible= cqlsHypo.enyo.app.$.checkData.getValue();
				self.deltaEstLim.shapes[1].visible= cqlsHypo.enyo.app.$.checkData.getValue();

				//Risk
				self.paramTypeIRisk.shapes[0].visible= cqlsHypo.enyo.app.$.checkRiskTypeI.getValue() & cqlsHypo.enyo.app.$.checkParam0Curve.getValue();
				self.paramTypeIRisk.shapes[1].visible= cqlsHypo.enyo.app.$.checkRiskTypeI.getValue() & cqlsHypo.enyo.app.$.checkParam0Curve.getValue();
				self.deltaTypeIRisk.shapes[0].visible= cqlsHypo.enyo.app.$.checkRiskTypeI.getValue() & cqlsHypo.enyo.app.$.checkDelta0Curve.getValue();
				self.deltaTypeIRisk.shapes[1].visible= cqlsHypo.enyo.app.$.checkRiskTypeI.getValue() & cqlsHypo.enyo.app.$.checkDelta0Curve.getValue();

				self.paramTypeGenRisk.shapes[0].visible= cqlsHypo.enyo.app.$.checkRiskTypeGen.getValue() & cqlsHypo.enyo.app.$.checkParam1Curve.getValue();
				self.paramTypeGenRisk.shapes[1].visible= cqlsHypo.enyo.app.$.checkRiskTypeGen.getValue() & cqlsHypo.enyo.app.$.checkParam1Curve.getValue();
				self.deltaTypeGenRisk.shapes[0].visible= cqlsHypo.enyo.app.$.checkRiskTypeGen.getValue() & cqlsHypo.enyo.app.$.checkDelta1Curve.getValue();
				self.deltaTypeGenRisk.shapes[1].visible= cqlsHypo.enyo.app.$.checkRiskTypeGen.getValue() & cqlsHypo.enyo.app.$.checkDelta1Curve.getValue();

				self.paramPvalRisk.shapes[0].visible= cqlsHypo.enyo.app.$.checkPval.getValue() & cqlsHypo.enyo.app.$.checkParam0Curve.getValue();
				self.paramPvalRisk.shapes[1].visible= cqlsHypo.enyo.app.$.checkPval.getValue() & cqlsHypo.enyo.app.$.checkParam0Curve.getValue();
				self.deltaPvalRisk.shapes[0].visible= cqlsHypo.enyo.app.$.checkPval.getValue() & cqlsHypo.enyo.app.$.checkDelta0Curve.getValue();
				self.deltaPvalRisk.shapes[1].visible= cqlsHypo.enyo.app.$.checkPval.getValue() & cqlsHypo.enyo.app.$.checkDelta0Curve.getValue();


				self.paramEst['$[]'](0).summaryShapes[0].visible=cqlsHypo.enyo.app.$.checkParam0Mean.getValue();
				self.paramEst['$[]'](0).summaryShapes[1].visible=cqlsHypo.enyo.app.$.checkParam0SD.getValue();
				self.paramEst['$[]'](1).summaryShapes[0].visible=cqlsHypo.enyo.app.$.checkParam1Mean.getValue();
				self.paramEst['$[]'](1).summaryShapes[1].visible=cqlsHypo.enyo.app.$.checkParam1SD.getValue();
				
				self.deltaEst['$[]'](0).summaryShapes[0].visible=cqlsHypo.enyo.app.$.checkDelta0Mean.getValue();
				self.deltaEst['$[]'](0).summaryShapes[1].visible=cqlsHypo.enyo.app.$.checkDelta0SD.getValue();
				self.deltaEst['$[]'](1).summaryShapes[0].visible=cqlsHypo.enyo.app.$.checkDelta1Mean.getValue();
				self.deltaEst['$[]'](1).summaryShapes[1].visible=cqlsHypo.enyo.app.$.checkDelta1SD.getValue();
...
if (v1 == null) v1 = nil;if (i1 == null) i1 = nil;
        return ($a = ($b = self.b2).$each_with_index, $a._p = (TMP_33 = function(v2, i2){var self = TMP_33._s || this, $a, v = nil;if (v2 == null) v2 = nil;if (i2 == null) i2 = nil;
          v = $scope.CqlsHypo.$quantize(v1['$+'](v2));
...
if (j1 == null) j1 = nil;if (j2 == null) j2 = nil;
    ...
    $opal.defs($scope.CqlsHypo, '$quantize', function(x, prec) {
      var self = this;
      if (prec == null) {
    ...
    $opal.defs($scope.CqlsHypo, '$equal', function(a, b) {
      var self = this;
      return a.toFixed($scope.PREC4DISC)===b.toFixed($scope.PREC4DISC);
    });

    $opal.defs($scope.CqlsHypo, '$range', function(low, high, step) {
      var self = this;
    ...
    $opal.defs($scope.CqlsHypo, '$seq', function(min, max, length) {
      var self = this;
