  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      def.$initTooltip = function(shape) {
        ...
        return ($a = ($b = shape).$each, $a._p = (TMP_1 = function(sh){var self = TMP_1._s || this;
if (sh == null) sh = nil;
    ...
    (function($base, $super) {
      ...
      def.$update = function() {
        ...
        return ($a = ($b = self.updateCalls).$each, $a._p = (TMP_2 = function(k, v){var self = TMP_2._s || this, $a, args = nil;
    ...
    (function($base, $super) {
      ...
      def.$update = function(active) {
        ...
        if ((($a = self['$synced?']()) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          list = ($a = ($b = self.list).$select, $a._p = (TMP_3 = function(e){var self = TMP_3._s || this, $a;
if (e == null) e = nil;
          return ((($a = active['$empty?']()) !== false && $a !== nil) ? $a : (active['$include?'](e['$[]'](1))))}, TMP_3._s = self, TMP_3), $a).call($b);
          self.xylim['$[]']("x")['$[]='](0, ($a = ($c = list).$map, $a._p = (TMP_4 = function(e){var self = TMP_4._s || this, e2 = nil;
if (e == null) e = nil;
          ...
          self.xylim['$[]']("x")['$[]='](1, ($a = ($d = list).$map, $a._p = (TMP_5 = function(e){var self = TMP_5._s || this, e2 = nil;
if (e == null) e = nil;
          e2 = ((function() {if (e['$[]'](0)['$==']("element")) {
              return e['$[]'](2).$xylim()
              } else {
          ...
          self.xylim['$[]']("y")['$[]='](0, ($a = ($e = list).$map, $a._p = (TMP_6 = function(e){var self = TMP_6._s || this, e2 = nil;
if (e == null) e = nil;
          e2 = ((function() {if (e['$[]'](0)['$==']("element")) {
              return e['$[]'](2).$xylim()
              } else {
          ...
          self.xylim['$[]']("y")['$[]='](1, ($a = ($f = list).$map, $a._p = (TMP_7 = function(e){var self = TMP_7._s || this, e2 = nil;
if (e == null) e = nil;
          e2 = ((function() {if (e['$[]'](0)['$==']("element")) {
              return e['$[]'](2).$xylim()
              } else {
        ...
        if ((($a = self.syncedChildren['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return ($a = ($g = self.syncedChildren).$each, $a._p = (TMP_8 = function(c){var self = TMP_8._s || this;
if (c == null) c = nil;
...
if (i == null) i = nil;
      ...
      def.$drawAreaSide = function(lim, side, shape, style, graph) {
        ...
        while ((($b = (($c = to['$<'](self.x.$length()['$-'](1))) ? self.x['$[]'](to)['$<='](lim) : $c)) !== nil && (!$b._isBoolean || $b == true))) {
        to = to['$+'](1)};}else if ("right"['$===']($case)) {$a = [self.x.$length()['$-'](1), self.x.$length()['$-'](1)], from = $a[0], to = $a[1];
        while ((($b = (($c = from['$>'](0)) ? self.x['$[]'](from)['$>='](lim) : $c)) !== nil && (!$b._isBoolean || $b == true))) {
        from = from['$-'](1)};}else if ("between"['$===']($case)) {$a = [0, self.x.$length()['$-'](1)], from = $a[0], to = $a[1];
        while ((($b = (($c = from['$<'](self.x.$length()['$-'](1))) ? self.x['$[]'](from)['$<'](lim['$[]'](0)) : $c)) !== nil && (!$b._isBoolean || $b == true))) {
        from = from['$+'](1)};
        while ((($b = (($c = to['$>'](0)) ? self.x['$[]'](to)['$>'](lim['$[]'](1)) : $c)) !== nil && (!$b._isBoolean || $b == true))) {
        to = to['$-'](1)};};
...
if (i == null) i = nil;
      ...
      return (def.$tooltipContent = function(shape, evt) {
        ...
        if ((($a = shape == self.summaryShapes['$[]'](0)) !== nil && (!$a._isBoolean || $a == true))) {
          return self.distrib.$mean().$to_s()
        } else if ((($a = shape==self.summaryShapes['$[]'](1)) !== nil && (!$a._isBoolean || $a == true))) {
    ...
    (function($base) {
      ...
      def.$addCallable = function(call, tag) {
        ...
        if ((($a = self.callables) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
          $a = [$hash2([], {}), $hash2([], {})], self.callables = $a[0], self.activeCallables = $a[1]
        };
        if ((($a = self.callables['$[]'](tag)) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
      ...
      def.$playCallables = function(tag) {
        ...
        if ((($a = ($b = self.callables['$[]'](tag), $b !== false && $b !== nil ?self.activeCallables['$[]'](tag) : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          return ($a = ($b = self.callables['$[]'](tag)).$each, $a._p = (TMP_20 = function(v){var self = TMP_20._s || this, $a, args = nil;
if (v == null) v = nil;
          args = v['$[]'](2);
            if (args !== false && args !== nil) {
              } else {
...
if (type == null) type = nil;
      ...
      def.$paramsFrameAtFrom = function(key, statTest2, key2) {
        ...
        if ((($a = key2['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
          key2 = key};
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(statTestH0, context, id) {
        ...
        if ((($a = (($b = $opal.cvars['@@limitCpt']) == null ? nil : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
...
if (s == null) s = nil;if (i == null) i = nil;
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(statTest, context, id) {
        ...
        if ((($a = (($b = $opal.cvars['@@areaCpt']) == null ? nil : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
...
if (side == null) side = nil;if (i == null) i = nil;
      ...
      return (def.$tooltipContent = function(shape, evt) {
        ...
        return self.context['$[]']("deltaPval");}else {return self.alpha}})();
        area = alpha;
        if ((($a = (($b = statTestQuantile !== false && statTestQuantile !== nil) ? self.statTest['$=='](statTestQuantile)['$!']() : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          param = (function() {$case = self.statTest.$typeStatTest();if ("dp0"['$===']($case) || "dm0"['$===']($case) || "dp1"['$===']($case) || "dm1"['$===']($case)) {return self.statTest.$paramsFrame()['$[]'](0).$paramsFrame()['$[]'](1)}else {return self.statTest.$paramsFrame()['$[]'](1)}})();
          side = (function() {if (self.side['$==']("context")) {
            return self.context['$[]']("side")
            } else {
    ...
    (function($base, $super) {
      ...
      def.$setStyles = function() {
        ...
        if ((($a = self.styles) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
          self.styles = $hash2([], {})
        };
    ...
    (function($base, $super) {
      ...
      def.$setAsTransfOf = function(dist, transf) {
        ...
        if ((($a = d.type === CONT) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return self.$p(["boundsDistrib", self.$step(), self.$bounds(), self.$pdf(self.$bounds()), ($a = ($b = self.$pdf(self.$bounds())).$inject, $a._p = (TMP_26 = function(e, e2){var self = TMP_26._s || this;
if (e == null) e = nil;if (e2 == null) e2 = nil;
      ...
      def.$bounds = function() {
        ...
        return (function() {$case = self.$type();if ("cont"['$===']($case)) {return ($a = ($b = qb).$map, $a._p = (TMP_27 = function(e){var self = TMP_27._s || this;
if (e == null) e = nil;
        return self.$quantile(e)}, TMP_27._s = self, TMP_27), $a).call($b)}else if ("disc"['$===']($case)) {if ((($a = self['$regular?']()) !== nil && (!$a._isBoolean || $a == true))) {
          $a = $opal.to_ary(($c = ($d = qb).$map, $c._p = (TMP_28 = function(e){var self = TMP_28._s || this;
if (e == null) e = nil;
          return self.$quantile(e)}, TMP_28._s = self, TMP_28), $c).call($d)), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]);
          s = self.$step();
          return ($a = ($c = $scope.Range.$new(0, ((b['$-'](a))['$/'](s))).$to_a()).$map, $a._p = (TMP_29 = function(e){var self = TMP_29._s || this;
if (e == null) e = nil;
      ...
      def.$step = function() {
        ...
        if ((($a = self['$regular?']()) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          b = self.$bounds();
          return ($a = ($b = ($range(1, b.$length(), true))).$map, $a._p = (TMP_30 = function(i){var self = TMP_30._s || this;
if (i == null) i = nil;
    ...
    (function($base, $super) {
      ...
      $opal.defs($scope.Convolution, '$power', function(d, n) {
        ...
        ($a = ($b = ($range(1, n, true))).$each, $a._p = (TMP_31 = function(i){var self = TMP_31._s || this;
if (i == null) i = nil;
...
if (v1 == null) v1 = nil;if (i1 == null) i1 = nil;
        return ($a = ($b = self.b2).$each_with_index, $a._p = (TMP_33 = function(v2, i2){var self = TMP_33._s || this, $a, v = nil;
