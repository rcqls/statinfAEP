...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$new', '$[]', '$addChild', '$<<', '$shape', '$plot=', '$graph=', '$add', '$>=', '$each', '$call', '$method', '$to_Y', '$+', '$*', '$-', '$<', '$[]=', '$empty?', '$xylim', '$zoom', '$syncedChildren', '$synced?', '$select', '$include?', '$min', '$map', '$==', '$max', '$/', '$update', '$===', '$id', '$each_key', '$showZoom', '$>', '$graph', '$to_s', '$length', '$initStep', '$seq', '$dim', '$to_X', '$mean', '$maxPdf', '$stdDev', '$sample', '$pdf', '$type', '$map!', '$step', '$y', '$to_f', '$abs', '$set', '$initDistrib', '$setAsTransfOf', '$regular?', '$bounds', '$initXYLim', '$adjust', '$drawCont', '$drawDisc', '$<=', '$include', '$setParamsFrame', '$to_x', '$updateStatTestDistrib', '$draw', '$drawMean', '$drawSD', '$playCallables', '$nil?', '$paramsFrame', '$setDistrib', '$setAlphaFromQuantile', '$cdf', '$distrib', '$setAlpha', '$getSides', '$each_with_index', '$quantile', '$typeStatTest', '$drawAreaSide', '$setStyles', '$style', '$setPlot', '$alpha=', '$style=', '$meanStyle', '$initEvents', '$addCallable', '$attachShapes', '$setStatMode', '$reset', '$paramsFrame=', '$typeStatTest=', '$setPval', '$sdStyle', '$getContext', '$active=', '$updateVisible', '$join', '$power', '$p', '$inject', '$qbounds', '$to_a', '$prepare', '$quantize', '$keys', '$sort']);
...
if (k == null) k = nil;
    ...
    (function($base, $super) {
      ...
      def.type = def.bounds = def.length = def.plot = def.axisShape = def.graph = def.summaryShapes = def.meanStyle = def.distrib = def.step = def.sdStyle = def.x = def.y = def.shape = def.style = nil;
      ...
      def.$initialize = function(id, type, bounds, length) {
        ...
        return self.axisShape = new createjs.Shape();
      };
...
if (i == null) i = nil;
        return shape.graphics.lt(graph.$to_X(self.x['$[]'](i))-shape.x,graph.$to_Y(self.y['$[]'](i)));}, TMP_16._s = self, TMP_16), $a).call($b);
...
if (i == null) i = nil;
      ...
      return (def.$drawAreaSide = function(lim, side, shape, style, graph) {
        var $a, $b, $c, TMP_18, self = this, $case = nil, from = nil, to = nil;
        if (style == null) {
          style = self.style
        }
        if (graph == null) {
        ...
        ($a = ($b = ($range(from, to, false))).$each, $a._p = (TMP_18 = function(i){var self = TMP_18._s || this;
          if (self.x == null) self.x = nil;
          if (self.y == null) self.y = nil;
if (i == null) i = nil;
        return shape.graphics.lt(graph.$to_X(self.x['$[]'](i))-shape.x,graph.$to_Y(self.y['$[]'](i)));}, TMP_18._s = self, TMP_18), $a).call($b);
    ...
    (function($base) {
      ...
      def.$playCallables = function(tag) {
        ...
        if (($a = ($b = self.callables['$[]'](tag), $b !== false && $b !== nil ?self.activeCallables['$[]'](tag) : $b)) !== false && $a !== nil) {
          return ($a = ($b = self.callables['$[]'](tag)).$each, $a._p = (TMP_19 = function(v){var self = TMP_19._s || this, $a, args = nil;if (v == null) v = nil;
          args = v['$[]'](2);
            if (($a = args) === false || $a === nil) {
              args = []};
            return ($a = v['$[]'](0).$method(v['$[]'](1))).$call.apply($a, [].concat(args));}, TMP_19._s = self, TMP_19), $a).call($b)
          } else {
          return nil
        };
      };
    ...
    (function($base, $super) {
      ...
      var def = $StatTestCurve._proto, $scope = $StatTestCurve._scope, TMP_20;
      ...
      def.$initialize = TMP_20 = function(type, params) {
        ...
        TMP_20._p = null;
        $opal.find_super_dispatcher(self, 'initialize', TMP_20, null).apply(self, []);
      ...
      def.$initEvents = function(types) {
        ...
        return ($a = ($b = types).$each, $a._p = (TMP_21 = function(type){var self = TMP_21._s || this, $case = nil;
...
if (type == null) type = nil;
        return (function() {$case = type;if ("mean"['$===']($case)) {
					...
					;}else { return nil }})()}, TMP_21._s = self, TMP_21), $a).call($b);
      };
    ...
    (function($base, $super) {
      ...
      def.$draw = function() {
        ...
        self.$getSides();
        return ($a = ($b = self.sides).$each_with_index, $a._p = (TMP_22 = function(s, i){var self = TMP_22._s || this;
...
if (s == null) s = nil;if (i == null) i = nil;
      ...
      return (def.$attachShapes = function() {
        var self = this;
    ...
    (function($base, $super) {
      ...
      def.side = def.context = def.statTest = def.alpha = def.sides = def.shapes = def.style = def.graph = def.plot = nil;
      self.$attr_accessor("alpha", "side", "style", "shapes");
      ...
      def.$draw = function() {
        var $a, $b, TMP_23, self = this, style = nil, graph = nil;
        self.$getSides();
        if (self.sides.$length()['$=='](3)) {
          ...
          return ($a = ($b = self.sides).$each_with_index, $a._p = (TMP_23 = function(side, i){var self = TMP_23._s || this;
...
if (side == null) side = nil;if (i == null) i = nil;
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(plotParam, plotDelta) {
        ...
        self.paramEst['$[]'](1).$meanStyle()['$[]=']("thickness", 6);
      ...
      def.$getContext = function() {
        ...
        self.paramEst['$[]'](0).$sdStyle()['$[]=']("thickness", 3);
        return self.paramEst['$[]'](1).$sdStyle()['$[]=']("thickness", 3);}else if ("m"['$===']($case)) {self.paramEst['$[]'](0)['$style='](self.styles['$[]']("unknown"));
        self.paramEst['$[]'](1)['$style='](self.styles['$[]']("unknown"));
        self.deltaEst['$[]'](0)['$style='](self.styles['$[]']("known"));
        self.deltaEst['$[]'](1)['$style='](self.styles['$[]']("unknown"));
        self.paramEst['$[]'](0).$sdStyle()['$[]=']("thickness", 6);
        return self.paramEst['$[]'](1).$sdStyle()['$[]=']("thickness", 6);}else { return nil }})();
      };
      ...
      def.$reset = function(curs) {
        ...
        ($a = ($b = curs).$each, $a._p = (TMP_24 = function(cur){var self = TMP_24._s || this;
          if (self.paramEst == null) self.paramEst = nil;
          if (self.deltaEst == null) self.deltaEst = nil;
if (cur == null) cur = nil;
        self.paramEst['$[]'](cur).$draw();
          return self.deltaEst['$[]'](cur).$draw();}, TMP_24._s = self, TMP_24), $a).call($b);
    ...
    (function($base, $super) {
      ...
      def.$setAsTransfOf = function(dist, transf) {
        var $a, $b, TMP_25, self = this, $case = nil, d = nil;
        ...
        if (($a = d.type === CONT) !== false && $a !== nil) {
          ...
          return self.$p(["boundsDistrib", self.$step(), self.$bounds(), self.$pdf(self.$bounds()), ($a = ($b = self.$pdf(self.$bounds())).$inject, $a._p = (TMP_25 = function(e, e2){var self = TMP_25._s || this;if (e == null) e = nil;if (e2 == null) e2 = nil;
          return e = e['$+'](e2)}, TMP_25._s = self, TMP_25), $a).call($b, 0)]);
        };}else { return nil }})();
      };
      ...
      def.$bounds = function() {
        var $a, $b, TMP_26, $c, $d, TMP_27, TMP_28, self = this, qb = nil, $case = nil, a = nil, b = nil, s = nil;
        qb = (function() {if (($a = self.originalDistrib) !== false && $a !== nil) {
          return self.originalDistrib.$qbounds()
          } else {
          return self.$qbounds()
        }; return nil; })();
        return (function() {$case = self.$type();if ("cont"['$===']($case)) {return ($a = ($b = qb).$map, $a._p = (TMP_26 = function(e){var self = TMP_26._s || this;if (e == null) e = nil;
        return self.$quantile(e)}, TMP_26._s = self, TMP_26), $a).call($b)}else if ("disc"['$===']($case)) {if (($a = self['$regular?']()) !== false && $a !== nil) {
          $a = $opal.to_ary(($c = ($d = qb).$map, $c._p = (TMP_27 = function(e){var self = TMP_27._s || this;if (e == null) e = nil;
          return self.$quantile(e)}, TMP_27._s = self, TMP_27), $c).call($d)), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]);
          s = self.$step();
          return ($a = ($c = $scope.Range.$new(0, ((b['$-'](a))['$/'](s))).$to_a()).$map, $a._p = (TMP_28 = function(e){var self = TMP_28._s || this;if (e == null) e = nil;
          return a['$+'](e['$*'](s))}, TMP_28._s = self, TMP_28), $a).call($c);
          } else {
      ...
      def.$step = function() {
        var $a, $b, TMP_29, self = this, b = nil;
        if (($a = self['$regular?']()) !== false && $a !== nil) {
          return self.distrib.step();
          } else {
          b = self.$bounds();
          return ($a = ($b = ($range(1, b.$length(), true))).$map, $a._p = (TMP_29 = function(i){var self = TMP_29._s || this;if (i == null) i = nil;
          return (b['$[]'](i)['$-'](b['$[]'](i['$-'](1)))).$abs()}, TMP_29._s = self, TMP_29), $a).call($b).$min().$to_f();
        };
      };
    ...
    (function($base, $super) {
      ...
      $opal.defs($scope.Convolution, '$power', function(d, n) {
        var $a, $b, TMP_30, self = this, dist = nil, b = nil, dist2 = nil, b2 = nil;
        ...
        ($a = ($b = ($range(1, n, true))).$each, $a._p = (TMP_30 = function(i){var self = TMP_30._s || this;if (i == null) i = nil;
        dist2 = new Convolution2(dist,dist2,b,b2);
          return b2 = dist2.values();}, TMP_30._s = self, TMP_30), $a).call($b);
        return dist2;
      });
      ...
      return (def.$prepare = function() {
        var $a, $b, TMP_31, $c, TMP_33, self = this, ind = nil;
        ind = $hash2([], {});
        ($a = ($b = self.b1).$each_with_index, $a._p = (TMP_31 = function(v1, i1){var self = TMP_31._s || this, $a, $b, TMP_32;
          if (self.b2 == null) self.b2 = nil;
if (v1 == null) v1 = nil;if (i1 == null) i1 = nil;
        return ($a = ($b = self.b2).$each_with_index, $a._p = (TMP_32 = function(v2, i2){var self = TMP_32._s || this, $a, v = nil;if (v2 == null) v2 = nil;if (i2 == null) i2 = nil;
          v = $scope.Cqls.$quantize(v1['$+'](v2));
            if (($a = ind.$keys()['$include?'](v)) !== false && $a !== nil) {
              return ind['$[]'](v)['$<<']([i1, i2])
              } else {
              return ind['$[]='](v, [[i1, i2]])
            };}, TMP_32._s = self, TMP_32), $a).call($b)}, TMP_31._s = self, TMP_31), $a).call($b);
        self.bounds = ind.$keys().$sort();
        self.pdf = [];
        return ($a = ($c = self.bounds).$each_with_index, $a._p = (TMP_33 = function(v, i){var self = TMP_33._s || this, $a, $b, TMP_34;
          if (self.pdf == null) self.pdf = nil;
if (v == null) v = nil;if (i == null) i = nil;
        self.pdf['$[]='](i, 0);
          return ($a = ($b = ind['$[]'](v)).$each, $a._p = (TMP_34 = function(j1, j2){var self = TMP_34._s || this, $a, $b;
            if (self.pdf == null) self.pdf = nil;
...
if (j1 == null) j1 = nil;if (j2 == null) j2 = nil;
          return ($a = i, $b = self.pdf, $b['$[]=']($a, $b['$[]']($a)['$+'](self.d1.density(self.b1['$[]'](j1))* self.d2.density(self.b2['$[]'](j2)))))}, TMP_34._s = self, TMP_34), $a).call($b);}, TMP_33._s = self, TMP_33), $a).call($c);
      }, nil);
    })(self, null);
